...
func (m *mockCharSaverAbilityBoost) SaveDefaultCombatAction(_ context.Context, _ int64, _ string) error {
	return nil
}
...
func (m *mockCharSaverAbilityBoost) SaveHeroPoints(_ context.Context, _ int64, _ int) error {
	return nil
}
func (m *mockCharSaverAbilityBoost) LoadHeroPoints(_ context.Context, _ int64) (int, error) {
	return 0, nil
}
func (m *mockCharSaverAbilityBoost) SaveJobs(_ context.Context, _ int64, _ map[string]int, _ string) error {
	return nil
}
func (m *mockCharSaverAbilityBoost) SaveInstanceCharges(_ context.Context, _ int64, _, _ string, _ int, _ bool) error {
	return nil
}
...
func (m *mockCharSaverAbilityBoost) SaveHotbars(_ context.Context, _ int64, _ [][10]session.HotbarSlot, _ int) error {
	return nil
}
func (m *mockCharSaverAbilityBoost) LoadHotbars(_ context.Context, _ int64) ([][10]session.HotbarSlot, int, error) {
