...
func (m *mockCharSaver) SaveProgress(_ context.Context, _ int64, _, _, _, _ int) error {
	return nil
}

func (m *mockCharSaver) SaveDefaultCombatAction(_ context.Context, _ int64, _ string) error {
	return nil
}
...
func (m *mockCharSaver) SaveInstanceCharges(_ context.Context, _ int64, _, _ string, _ int, _ bool) error {
	return nil
}
...
func (m *mockCharSaver) SaveHotbars(_ context.Context, _ int64, _ [][10]session.HotbarSlot, _ int) error {
	return nil
}
func (m *mockCharSaver) LoadHotbars(_ context.Context, _ int64) ([][10]session.HotbarSlot, int, error) {
