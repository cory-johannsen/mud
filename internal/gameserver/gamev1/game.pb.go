...
type HotbarRequest struct {
	...
	Text          string                 `protobuf:"bytes,3,opt,name=text,proto3" json:"text,omitempty"`     // non-empty for set; ignored for clear/show
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *HotbarUpdateEvent) GetSlots() []string {
	if x != nil {
		return x.Slots
	}
	return nil
...
const file_game_v1_game_proto_rawDesc = "" +
	"\n" +
	"\x12game/v1/game.proto\x12\agame.v1\"\xd3<\n" +
	...
	"\x10kill_npc_request\x18\x86\x01 \x01(\v2\x17.game.v1.KillNPCRequestH\x00R\x0ekillNpcRequestB\t\n" +
	"\apayload\"\r\n" +
	"\vRestRequest\"\x13\n" +
	...
	"\n" +
	"item_query\x18\x01 \x01(\tR\titemQuery\"\xc3\x0f\n" +
	...
	"\x0fplayer_currency\x18\x04 \x01(\x05R\x0eplayerCurrency\"'\n" +
	...
	"\bnpc_name\x18\x02 \x01(\tR\anpcName\"\x8f\x02\n" +
	"\aMapTile\x12\x17\n" +
	...
	"\bpoi_npcs\x18\n" +
	" \x03(\v2\x13.game.v1.PoiWithNpcR\apoiNpcs\"\xd4\x01\n" +
	...
	"\x11HotbarUpdateEvent\x12\x14\n" +
	"\x05slots\x18\x01 \x03(\tR\x05slots\"E\n" +
...
var file_game_v1_game_proto_msgTypes = make([]protoimpl.MessageInfo, 194)
var file_game_v1_game_proto_goTypes = []any{
	...
	(*ActivateItemRequest)(nil),       // 31: game.v1.ActivateItemRequest
	(*ServerEvent)(nil),               // 32: game.v1.ServerEvent
	(*ShopItem)(nil),                  // 33: game.v1.ShopItem
	(*ShopView)(nil),                  // 34: game.v1.ShopView
	(*HpUpdateEvent)(nil),             // 35: game.v1.HpUpdateEvent
	(*JoinWorldRequest)(nil),          // 36: game.v1.JoinWorldRequest
	(*MoveRequest)(nil),               // 37: game.v1.MoveRequest
	(*LookRequest)(nil),               // 38: game.v1.LookRequest
	(*SayRequest)(nil),                // 39: game.v1.SayRequest
	(*EmoteRequest)(nil),              // 40: game.v1.EmoteRequest
	(*WhoRequest)(nil),                // 41: game.v1.WhoRequest
	(*ExitsRequest)(nil),              // 42: game.v1.ExitsRequest
	(*QuitRequest)(nil),               // 43: game.v1.QuitRequest
	(*SwitchCharacterRequest)(nil),    // 44: game.v1.SwitchCharacterRequest
	(*RoomView)(nil),                  // 45: game.v1.RoomView
	(*ExitInfo)(nil),                  // 46: game.v1.ExitInfo
	(*MessageEvent)(nil),              // 47: game.v1.MessageEvent
	(*RoomEvent)(nil),                 // 48: game.v1.RoomEvent
	(*PlayerList)(nil),                // 49: game.v1.PlayerList
	(*PlayerInfo)(nil),                // 50: game.v1.PlayerInfo
	(*ExitList)(nil),                  // 51: game.v1.ExitList
	(*ErrorEvent)(nil),                // 52: game.v1.ErrorEvent
	(*Disconnected)(nil),              // 53: game.v1.Disconnected
	(*TimeOfDayEvent)(nil),            // 54: game.v1.TimeOfDayEvent
	(*CharacterInfo)(nil),             // 55: game.v1.CharacterInfo
	(*NpcInfo)(nil),                   // 56: game.v1.NpcInfo
	(*ExamineRequest)(nil),            // 57: game.v1.ExamineRequest
	(*NpcView)(nil),                   // 58: game.v1.NpcView
	(*HealerView)(nil),                // 59: game.v1.HealerView
	(*JobOfferEntry)(nil),             // 60: game.v1.JobOfferEntry
	(*TrainerView)(nil),               // 61: game.v1.TrainerView
	(*AttackRequest)(nil),             // 62: game.v1.AttackRequest
	(*FleeRequest)(nil),               // 63: game.v1.FleeRequest
	(*PassRequest)(nil),               // 64: game.v1.PassRequest
	(*StrikeRequest)(nil),             // 65: game.v1.StrikeRequest
	(*EquipRequest)(nil),              // 66: game.v1.EquipRequest
	(*ReloadRequest)(nil),             // 67: game.v1.ReloadRequest
	(*FireBurstRequest)(nil),          // 68: game.v1.FireBurstRequest
	(*FireAutomaticRequest)(nil),      // 69: game.v1.FireAutomaticRequest
	(*ThrowRequest)(nil),              // 70: game.v1.ThrowRequest
	(*InventoryRequest)(nil),          // 71: game.v1.InventoryRequest
	(*GetItemRequest)(nil),            // 72: game.v1.GetItemRequest
	(*DropItemRequest)(nil),           // 73: game.v1.DropItemRequest
	(*BalanceRequest)(nil),            // 74: game.v1.BalanceRequest
	(*SetRoleRequest)(nil),            // 75: game.v1.SetRoleRequest
	(*LoadoutRequest)(nil),            // 76: game.v1.LoadoutRequest
	(*LoadoutWeaponPreset)(nil),       // 77: game.v1.LoadoutWeaponPreset
	(*LoadoutView)(nil),               // 78: game.v1.LoadoutView
	(*UnequipRequest)(nil),            // 79: game.v1.UnequipRequest
	(*EquipmentRequest)(nil),          // 80: game.v1.EquipmentRequest
	(*TeleportRequest)(nil),           // 81: game.v1.TeleportRequest
	(*SummonItemRequest)(nil),         // 82: game.v1.SummonItemRequest
	(*FloorItem)(nil),                 // 83: game.v1.FloorItem
	(*RoomEquipmentItem)(nil),         // 84: game.v1.RoomEquipmentItem
	(*UseEquipmentRequest)(nil),       // 85: game.v1.UseEquipmentRequest
	(*MapRequest)(nil),                // 86: game.v1.MapRequest
	(*PoiWithNpc)(nil),                // 87: game.v1.PoiWithNpc
	(*MapTile)(nil),                   // 88: game.v1.MapTile
	(*WorldZoneTile)(nil),             // 89: game.v1.WorldZoneTile
	(*MapResponse)(nil),               // 90: game.v1.MapResponse
	(*SkillsRequest)(nil),             // 91: game.v1.SkillsRequest
	(*SkillEntry)(nil),                // 92: game.v1.SkillEntry
	(*SkillsResponse)(nil),            // 93: game.v1.SkillsResponse
	(*RoomEquipRequest)(nil),          // 94: game.v1.RoomEquipRequest
	(*InventoryItem)(nil),             // 95: game.v1.InventoryItem
	(*InventoryView)(nil),             // 96: game.v1.InventoryView
	(*RoundStartEvent)(nil),           // 97: game.v1.RoundStartEvent
	(*RoundEndEvent)(nil),             // 98: game.v1.RoundEndEvent
	(*CombatEvent)(nil),               // 99: game.v1.CombatEvent
	(*StatusRequest)(nil),             // 100: game.v1.StatusRequest
	(*ConditionEvent)(nil),            // 101: game.v1.ConditionEvent
	(*WearRequest)(nil),               // 102: game.v1.WearRequest
	(*RemoveArmorRequest)(nil),        // 103: game.v1.RemoveArmorRequest
	(*ConditionInfo)(nil),             // 104: game.v1.ConditionInfo
	(*CharacterSheetRequest)(nil),     // 105: game.v1.CharacterSheetRequest
	(*ArchetypeSelectionRequest)(nil), // 106: game.v1.ArchetypeSelectionRequest
	(*FeatsRequest)(nil),              // 107: game.v1.FeatsRequest
	(*FeatEntry)(nil),                 // 108: game.v1.FeatEntry
	(*FeatsResponse)(nil),             // 109: game.v1.FeatsResponse
	(*ClassFeaturesRequest)(nil),      // 110: game.v1.ClassFeaturesRequest
	(*ClassFeatureEntry)(nil),         // 111: game.v1.ClassFeatureEntry
	(*ClassFeaturesResponse)(nil),     // 112: game.v1.ClassFeaturesResponse
	(*InteractRequest)(nil),           // 113: game.v1.InteractRequest
	(*InteractResponse)(nil),          // 114: game.v1.InteractResponse
	(*UseRequest)(nil),                // 115: game.v1.UseRequest
	(*UseResponse)(nil),               // 116: game.v1.UseResponse
	(*PreparedSlotView)(nil),          // 117: game.v1.PreparedSlotView
	(*HardwiredSlotView)(nil),         // 118: game.v1.HardwiredSlotView
	(*SpontaneousKnownEntry)(nil),     // 119: game.v1.SpontaneousKnownEntry
	(*CharacterSheetView)(nil),        // 120: game.v1.CharacterSheetView
	(*InnateSlotView)(nil),            // 121: game.v1.InnateSlotView
	(*SpontaneousUsePoolView)(nil),    // 122: game.v1.SpontaneousUsePoolView
	(*ResistanceEntry)(nil),           // 123: game.v1.ResistanceEntry
	(*ProficienciesRequest)(nil),      // 124: game.v1.ProficienciesRequest
	(*ProficiencyEntry)(nil),          // 125: game.v1.ProficiencyEntry
	(*ProficienciesResponse)(nil),     // 126: game.v1.ProficienciesResponse
	(*LevelUpRequest)(nil),            // 127: game.v1.LevelUpRequest
	(*CombatDefaultRequest)(nil),      // 128: game.v1.CombatDefaultRequest
	(*TrainSkillRequest)(nil),         // 129: game.v1.TrainSkillRequest
	(*ActionRequest)(nil),             // 130: game.v1.ActionRequest
	(*RaiseShieldRequest)(nil),        // 131: game.v1.RaiseShieldRequest
	(*TakeCoverRequest)(nil),          // 132: game.v1.TakeCoverRequest
	(*FirstAidRequest)(nil),           // 133: game.v1.FirstAidRequest
	(*FeintRequest)(nil),              // 134: game.v1.FeintRequest
	(*DemoralizeRequest)(nil),         // 135: game.v1.DemoralizeRequest
	(*GrappleRequest)(nil),            // 136: game.v1.GrappleRequest
	(*TripRequest)(nil),               // 137: game.v1.TripRequest
	(*DisarmRequest)(nil),             // 138: game.v1.DisarmRequest
	(*StrideRequest)(nil),             // 139: game.v1.StrideRequest
	(*ShoveRequest)(nil),              // 140: game.v1.ShoveRequest
	(*StepRequest)(nil),               // 141: game.v1.StepRequest
	(*HideRequest)(nil),               // 142: game.v1.HideRequest
	(*SneakRequest)(nil),              // 143: game.v1.SneakRequest
	(*DivertRequest)(nil),             // 144: game.v1.DivertRequest
	(*EscapeRequest)(nil),             // 145: game.v1.EscapeRequest
	(*TumbleRequest)(nil),             // 146: game.v1.TumbleRequest
	(*SeekRequest)(nil),               // 147: game.v1.SeekRequest
	(*ClimbRequest)(nil),              // 148: game.v1.ClimbRequest
	(*SwimRequest)(nil),               // 149: game.v1.SwimRequest
	(*CalmRequest)(nil),               // 150: game.v1.CalmRequest
	(*HeroPointRequest)(nil),          // 151: game.v1.HeroPointRequest
	(*DelayRequest)(nil),              // 152: game.v1.DelayRequest
	(*JoinRequest)(nil),               // 153: game.v1.JoinRequest
	(*DeclineRequest)(nil),            // 154: game.v1.DeclineRequest
	(*GroupRequest)(nil),              // 155: game.v1.GroupRequest
	(*InviteRequest)(nil),             // 156: game.v1.InviteRequest
	(*AcceptGroupRequest)(nil),        // 157: game.v1.AcceptGroupRequest
	(*DeclineGroupRequest)(nil),       // 158: game.v1.DeclineGroupRequest
	(*UngroupRequest)(nil),            // 159: game.v1.UngroupRequest
	(*KickRequest)(nil),               // 160: game.v1.KickRequest
	(*MotiveRequest)(nil),             // 161: game.v1.MotiveRequest
	(*GrantRequest)(nil),              // 162: game.v1.GrantRequest
	(*SpawnNPCRequest)(nil),           // 163: game.v1.SpawnNPCRequest
	(*KillNPCRequest)(nil),            // 164: game.v1.KillNPCRequest
	(*AddRoomRequest)(nil),            // 165: game.v1.AddRoomRequest
	(*AddLinkRequest)(nil),            // 166: game.v1.AddLinkRequest
	(*RemoveLinkRequest)(nil),         // 167: game.v1.RemoveLinkRequest
	(*SetRoomRequest)(nil),            // 168: game.v1.SetRoomRequest
	(*EditorCmdsRequest)(nil),         // 169: game.v1.EditorCmdsRequest
	(*SpawnCharRequest)(nil),          // 170: game.v1.SpawnCharRequest
	(*DeleteCharRequest)(nil),         // 171: game.v1.DeleteCharRequest
	(*FactionRequest)(nil),            // 172: game.v1.FactionRequest
	(*FactionInfoRequest)(nil),        // 173: game.v1.FactionInfoRequest
	(*FactionStandingRequest)(nil),    // 174: game.v1.FactionStandingRequest
	(*ChangeRepRequest)(nil),          // 175: game.v1.ChangeRepRequest
	(*TabCompleteRequest)(nil),        // 176: game.v1.TabCompleteRequest
	(*TabCompleteResponse)(nil),       // 177: game.v1.TabCompleteResponse
	(*MaterialsRequest)(nil),          // 178: game.v1.MaterialsRequest
	(*CraftListRequest)(nil),          // 179: game.v1.CraftListRequest
	(*CraftRequest)(nil),              // 180: game.v1.CraftRequest
	(*CraftConfirmRequest)(nil),       // 181: game.v1.CraftConfirmRequest
	(*ScavengeRequest)(nil),           // 182: game.v1.ScavengeRequest
	(*AffixRequest)(nil),              // 183: game.v1.AffixRequest
	(*ExploreRequest)(nil),            // 184: game.v1.ExploreRequest
	(*RefocusRequest)(nil),            // 185: game.v1.RefocusRequest
	(*SeduceRequest)(nil),             // 186: game.v1.SeduceRequest
	(*HotbarRequest)(nil),             // 187: game.v1.HotbarRequest
	(*HotbarUpdateEvent)(nil),         // 188: game.v1.HotbarUpdateEvent
	(*DowntimeRequest)(nil),           // 189: game.v1.DowntimeRequest
	(*QuestRequest)(nil),              // 190: game.v1.QuestRequest
	(*MaterialLoss)(nil),              // 191: game.v1.MaterialLoss
	(*CraftResultEvent)(nil),          // 192: game.v1.CraftResultEvent
	(*UncurseRequest)(nil),            // 193: game.v1.UncurseRequest
	(*WeatherEvent)(nil),              // 194: game.v1.WeatherEvent
	nil,                               // 195: game.v1.CharacterSheetView.ArmorEntry
	nil,                               // 196: game.v1.CharacterSheetView.AccessoriesEntry
	nil,                               // 197: game.v1.CharacterSheetView.ArmorCategoriesEntry
}
var file_game_v1_game_proto_depIdxs = []int32{
	36,  // 0: game.v1.ClientMessage.join_world:type_name -> game.v1.JoinWorldRequest
	37,  // 1: game.v1.ClientMessage.move:type_name -> game.v1.MoveRequest
	38,  // 2: game.v1.ClientMessage.look:type_name -> game.v1.LookRequest
	39,  // 3: game.v1.ClientMessage.say:type_name -> game.v1.SayRequest
	40,  // 4: game.v1.ClientMessage.emote:type_name -> game.v1.EmoteRequest
	41,  // 5: game.v1.ClientMessage.who:type_name -> game.v1.WhoRequest
	42,  // 6: game.v1.ClientMessage.exits:type_name -> game.v1.ExitsRequest
	43,  // 7: game.v1.ClientMessage.quit:type_name -> game.v1.QuitRequest
	57,  // 8: game.v1.ClientMessage.examine:type_name -> game.v1.ExamineRequest
	62,  // 9: game.v1.ClientMessage.attack:type_name -> game.v1.AttackRequest
	63,  // 10: game.v1.ClientMessage.flee:type_name -> game.v1.FleeRequest
	64,  // 11: game.v1.ClientMessage.pass:type_name -> game.v1.PassRequest
	65,  // 12: game.v1.ClientMessage.strike:type_name -> game.v1.StrikeRequest
	100, // 13: game.v1.ClientMessage.status:type_name -> game.v1.StatusRequest
	66,  // 14: game.v1.ClientMessage.equip:type_name -> game.v1.EquipRequest
	67,  // 15: game.v1.ClientMessage.reload:type_name -> game.v1.ReloadRequest
	68,  // 16: game.v1.ClientMessage.fire_burst:type_name -> game.v1.FireBurstRequest
	69,  // 17: game.v1.ClientMessage.fire_automatic:type_name -> game.v1.FireAutomaticRequest
	70,  // 18: game.v1.ClientMessage.throw:type_name -> game.v1.ThrowRequest
	71,  // 19: game.v1.ClientMessage.inventory_req:type_name -> game.v1.InventoryRequest
	72,  // 20: game.v1.ClientMessage.get_item:type_name -> game.v1.GetItemRequest
	73,  // 21: game.v1.ClientMessage.drop_item:type_name -> game.v1.DropItemRequest
	74,  // 22: game.v1.ClientMessage.balance:type_name -> game.v1.BalanceRequest
	75,  // 23: game.v1.ClientMessage.set_role:type_name -> game.v1.SetRoleRequest
	81,  // 24: game.v1.ClientMessage.teleport:type_name -> game.v1.TeleportRequest
	76,  // 25: game.v1.ClientMessage.loadout:type_name -> game.v1.LoadoutRequest
	79,  // 26: game.v1.ClientMessage.unequip:type_name -> game.v1.UnequipRequest
	80,  // 27: game.v1.ClientMessage.equipment:type_name -> game.v1.EquipmentRequest
	44,  // 28: game.v1.ClientMessage.switch_character:type_name -> game.v1.SwitchCharacterRequest
	102, // 29: game.v1.ClientMessage.wear:type_name -> game.v1.WearRequest
	103, // 30: game.v1.ClientMessage.remove_armor:type_name -> game.v1.RemoveArmorRequest
	105, // 31: game.v1.ClientMessage.char_sheet:type_name -> game.v1.CharacterSheetRequest
	106, // 32: game.v1.ClientMessage.archetype_selection:type_name -> game.v1.ArchetypeSelectionRequest
	85,  // 33: game.v1.ClientMessage.use_equipment:type_name -> game.v1.UseEquipmentRequest
	94,  // 34: game.v1.ClientMessage.room_equip:type_name -> game.v1.RoomEquipRequest
	86,  // 35: game.v1.ClientMessage.map:type_name -> game.v1.MapRequest
	91,  // 36: game.v1.ClientMessage.skills_request:type_name -> game.v1.SkillsRequest
	107, // 37: game.v1.ClientMessage.feats_request:type_name -> game.v1.FeatsRequest
	113, // 38: game.v1.ClientMessage.interact_request:type_name -> game.v1.InteractRequest
	115, // 39: game.v1.ClientMessage.use_request:type_name -> game.v1.UseRequest
	110, // 40: game.v1.ClientMessage.class_features_request:type_name -> game.v1.ClassFeaturesRequest
	82,  // 41: game.v1.ClientMessage.summon_item:type_name -> game.v1.SummonItemRequest
	124, // 42: game.v1.ClientMessage.proficiencies_request:type_name -> game.v1.ProficienciesRequest
	127, // 43: game.v1.ClientMessage.level_up:type_name -> game.v1.LevelUpRequest
	128, // 44: game.v1.ClientMessage.combat_default:type_name -> game.v1.CombatDefaultRequest
	129, // 45: game.v1.ClientMessage.train_skill:type_name -> game.v1.TrainSkillRequest
	130, // 46: game.v1.ClientMessage.action:type_name -> game.v1.ActionRequest
	131, // 47: game.v1.ClientMessage.raise_shield:type_name -> game.v1.RaiseShieldRequest
	132, // 48: game.v1.ClientMessage.take_cover:type_name -> game.v1.TakeCoverRequest
	133, // 49: game.v1.ClientMessage.first_aid:type_name -> game.v1.FirstAidRequest
	134, // 50: game.v1.ClientMessage.feint:type_name -> game.v1.FeintRequest
	135, // 51: game.v1.ClientMessage.demoralize:type_name -> game.v1.DemoralizeRequest
	136, // 52: game.v1.ClientMessage.grapple:type_name -> game.v1.GrappleRequest
	137, // 53: game.v1.ClientMessage.trip:type_name -> game.v1.TripRequest
	142, // 54: game.v1.ClientMessage.hide:type_name -> game.v1.HideRequest
	143, // 55: game.v1.ClientMessage.sneak:type_name -> game.v1.SneakRequest
	144, // 56: game.v1.ClientMessage.divert:type_name -> game.v1.DivertRequest
	145, // 57: game.v1.ClientMessage.escape:type_name -> game.v1.EscapeRequest
	162, // 58: game.v1.ClientMessage.grant:type_name -> game.v1.GrantRequest
	138, // 59: game.v1.ClientMessage.disarm:type_name -> game.v1.DisarmRequest
	139, // 60: game.v1.ClientMessage.stride:type_name -> game.v1.StrideRequest
	140, // 61: game.v1.ClientMessage.shove:type_name -> game.v1.ShoveRequest
	141, // 62: game.v1.ClientMessage.step:type_name -> game.v1.StepRequest
	146, // 63: game.v1.ClientMessage.tumble:type_name -> game.v1.TumbleRequest
	147, // 64: game.v1.ClientMessage.seek:type_name -> game.v1.SeekRequest
	148, // 65: game.v1.ClientMessage.climb:type_name -> game.v1.ClimbRequest
	149, // 66: game.v1.ClientMessage.swim:type_name -> game.v1.SwimRequest
	161, // 67: game.v1.ClientMessage.motive:type_name -> game.v1.MotiveRequest
	150, // 68: game.v1.ClientMessage.calm:type_name -> game.v1.CalmRequest
	151, // 69: game.v1.ClientMessage.hero_point:type_name -> game.v1.HeroPointRequest
	152, // 70: game.v1.ClientMessage.delay:type_name -> game.v1.DelayRequest
	153, // 71: game.v1.ClientMessage.join:type_name -> game.v1.JoinRequest
	154, // 72: game.v1.ClientMessage.decline:type_name -> game.v1.DeclineRequest
	155, // 73: game.v1.ClientMessage.group:type_name -> game.v1.GroupRequest
	156, // 74: game.v1.ClientMessage.invite:type_name -> game.v1.InviteRequest
	157, // 75: game.v1.ClientMessage.accept_group:type_name -> game.v1.AcceptGroupRequest
	158, // 76: game.v1.ClientMessage.decline_group:type_name -> game.v1.DeclineGroupRequest
	159, // 77: game.v1.ClientMessage.ungroup:type_name -> game.v1.UngroupRequest
	160, // 78: game.v1.ClientMessage.kick:type_name -> game.v1.KickRequest
	...
	163, // 104: game.v1.ClientMessage.spawn_npc:type_name -> game.v1.SpawnNPCRequest
	165, // 105: game.v1.ClientMessage.add_room:type_name -> game.v1.AddRoomRequest
	166, // 106: game.v1.ClientMessage.add_link:type_name -> game.v1.AddLinkRequest
	167, // 107: game.v1.ClientMessage.remove_link:type_name -> game.v1.RemoveLinkRequest
	168, // 108: game.v1.ClientMessage.set_room:type_name -> game.v1.SetRoomRequest
	169, // 109: game.v1.ClientMessage.editor_cmds:type_name -> game.v1.EditorCmdsRequest
	30,  // 110: game.v1.ClientMessage.travel:type_name -> game.v1.TravelRequest
	31,  // 111: game.v1.ClientMessage.activate_item:type_name -> game.v1.ActivateItemRequest
	172, // 112: game.v1.ClientMessage.faction_request:type_name -> game.v1.FactionRequest
	173, // 113: game.v1.ClientMessage.faction_info_request:type_name -> game.v1.FactionInfoRequest
	174, // 114: game.v1.ClientMessage.faction_standing_request:type_name -> game.v1.FactionStandingRequest
	175, // 115: game.v1.ClientMessage.change_rep_request:type_name -> game.v1.ChangeRepRequest
	176, // 116: game.v1.ClientMessage.tab_complete:type_name -> game.v1.TabCompleteRequest
	178, // 117: game.v1.ClientMessage.materials_request:type_name -> game.v1.MaterialsRequest
	179, // 118: game.v1.ClientMessage.craft_list_request:type_name -> game.v1.CraftListRequest
	180, // 119: game.v1.ClientMessage.craft_request:type_name -> game.v1.CraftRequest
	181, // 120: game.v1.ClientMessage.craft_confirm_request:type_name -> game.v1.CraftConfirmRequest
	182, // 121: game.v1.ClientMessage.scavenge_request:type_name -> game.v1.ScavengeRequest
	183, // 122: game.v1.ClientMessage.affix_request:type_name -> game.v1.AffixRequest
	184, // 123: game.v1.ClientMessage.explore_request:type_name -> game.v1.ExploreRequest
	190, // 124: game.v1.ClientMessage.quest_request:type_name -> game.v1.QuestRequest
	193, // 125: game.v1.ClientMessage.uncurse_request:type_name -> game.v1.UncurseRequest
	189, // 126: game.v1.ClientMessage.downtime_request:type_name -> game.v1.DowntimeRequest
	185, // 127: game.v1.ClientMessage.refocus_request:type_name -> game.v1.RefocusRequest
	186, // 128: game.v1.ClientMessage.seduce_request:type_name -> game.v1.SeduceRequest
	187, // 129: game.v1.ClientMessage.hotbar_request:type_name -> game.v1.HotbarRequest
	170, // 130: game.v1.ClientMessage.spawn_char_request:type_name -> game.v1.SpawnCharRequest
	171, // 131: game.v1.ClientMessage.delete_char_request:type_name -> game.v1.DeleteCharRequest
	164, // 132: game.v1.ClientMessage.kill_npc_request:type_name -> game.v1.KillNPCRequest
	45,  // 133: game.v1.ServerEvent.room_view:type_name -> game.v1.RoomView
	47,  // 134: game.v1.ServerEvent.message:type_name -> game.v1.MessageEvent
	48,  // 135: game.v1.ServerEvent.room_event:type_name -> game.v1.RoomEvent
	49,  // 136: game.v1.ServerEvent.player_list:type_name -> game.v1.PlayerList
	51,  // 137: game.v1.ServerEvent.exit_list:type_name -> game.v1.ExitList
	52,  // 138: game.v1.ServerEvent.error:type_name -> game.v1.ErrorEvent
	53,  // 139: game.v1.ServerEvent.disconnected:type_name -> game.v1.Disconnected
	55,  // 140: game.v1.ServerEvent.character_info:type_name -> game.v1.CharacterInfo
	58,  // 141: game.v1.ServerEvent.npc_view:type_name -> game.v1.NpcView
	99,  // 142: game.v1.ServerEvent.combat_event:type_name -> game.v1.CombatEvent
	97,  // 143: game.v1.ServerEvent.round_start:type_name -> game.v1.RoundStartEvent
	98,  // 144: game.v1.ServerEvent.round_end:type_name -> game.v1.RoundEndEvent
	101, // 145: game.v1.ServerEvent.condition_event:type_name -> game.v1.ConditionEvent
	96,  // 146: game.v1.ServerEvent.inventory_view:type_name -> game.v1.InventoryView
	54,  // 147: game.v1.ServerEvent.time_of_day:type_name -> game.v1.TimeOfDayEvent
	120, // 148: game.v1.ServerEvent.character_sheet:type_name -> game.v1.CharacterSheetView
	90,  // 149: game.v1.ServerEvent.map:type_name -> game.v1.MapResponse
	93,  // 150: game.v1.ServerEvent.skills_response:type_name -> game.v1.SkillsResponse
	109, // 151: game.v1.ServerEvent.feats_response:type_name -> game.v1.FeatsResponse
	114, // 152: game.v1.ServerEvent.interact_response:type_name -> game.v1.InteractResponse
	116, // 153: game.v1.ServerEvent.use_response:type_name -> game.v1.UseResponse
	112, // 154: game.v1.ServerEvent.class_features_response:type_name -> game.v1.ClassFeaturesResponse
	126, // 155: game.v1.ServerEvent.proficiencies_response:type_name -> game.v1.ProficienciesResponse
	35,  // 156: game.v1.ServerEvent.hp_update:type_name -> game.v1.HpUpdateEvent
	177, // 157: game.v1.ServerEvent.tab_complete:type_name -> game.v1.TabCompleteResponse
	192, // 158: game.v1.ServerEvent.craft_result:type_name -> game.v1.CraftResultEvent
	188, // 159: game.v1.ServerEvent.hotbar_update:type_name -> game.v1.HotbarUpdateEvent
	...
	194, // 163: game.v1.ServerEvent.weather:type_name -> game.v1.WeatherEvent
	78,  // 164: game.v1.ServerEvent.loadout_view:type_name -> game.v1.LoadoutView
	33,  // 165: game.v1.ShopView.items:type_name -> game.v1.ShopItem
	46,  // 166: game.v1.RoomView.exits:type_name -> game.v1.ExitInfo
	56,  // 167: game.v1.RoomView.npcs:type_name -> game.v1.NpcInfo
	104, // 168: game.v1.RoomView.active_conditions:type_name -> game.v1.ConditionInfo
	83,  // 169: game.v1.RoomView.floor_items:type_name -> game.v1.FloorItem
	84,  // 170: game.v1.RoomView.equipment:type_name -> game.v1.RoomEquipmentItem
	0,   // 171: game.v1.MessageEvent.type:type_name -> game.v1.MessageType
	1,   // 172: game.v1.RoomEvent.type:type_name -> game.v1.RoomEventType
	50,  // 173: game.v1.PlayerList.players:type_name -> game.v1.PlayerInfo
	2,   // 174: game.v1.PlayerInfo.status:type_name -> game.v1.CombatStatus
	46,  // 175: game.v1.ExitList.exits:type_name -> game.v1.ExitInfo
	60,  // 176: game.v1.TrainerView.jobs:type_name -> game.v1.JobOfferEntry
	77,  // 177: game.v1.LoadoutView.presets:type_name -> game.v1.LoadoutWeaponPreset
	87,  // 178: game.v1.MapTile.poi_npcs:type_name -> game.v1.PoiWithNpc
	88,  // 179: game.v1.MapResponse.tiles:type_name -> game.v1.MapTile
	89,  // 180: game.v1.MapResponse.world_tiles:type_name -> game.v1.WorldZoneTile
	92,  // 181: game.v1.SkillsResponse.skills:type_name -> game.v1.SkillEntry
	95,  // 182: game.v1.InventoryView.items:type_name -> game.v1.InventoryItem
	3,   // 183: game.v1.CombatEvent.type:type_name -> game.v1.CombatEventType
	108, // 184: game.v1.FeatsResponse.feats:type_name -> game.v1.FeatEntry
	111, // 185: game.v1.ClassFeaturesResponse.archetype_features:type_name -> game.v1.ClassFeatureEntry
	111, // 186: game.v1.ClassFeaturesResponse.job_features:type_name -> game.v1.ClassFeatureEntry
	108, // 187: game.v1.UseResponse.choices:type_name -> game.v1.FeatEntry
	195, // 188: game.v1.CharacterSheetView.armor:type_name -> game.v1.CharacterSheetView.ArmorEntry
	196, // 189: game.v1.CharacterSheetView.accessories:type_name -> game.v1.CharacterSheetView.AccessoriesEntry
	123, // 190: game.v1.CharacterSheetView.player_resistances:type_name -> game.v1.ResistanceEntry
	123, // 191: game.v1.CharacterSheetView.player_weaknesses:type_name -> game.v1.ResistanceEntry
	92,  // 192: game.v1.CharacterSheetView.skills:type_name -> game.v1.SkillEntry
	108, // 193: game.v1.CharacterSheetView.feats:type_name -> game.v1.FeatEntry
	111, // 194: game.v1.CharacterSheetView.class_features:type_name -> game.v1.ClassFeatureEntry
	125, // 195: game.v1.CharacterSheetView.proficiencies:type_name -> game.v1.ProficiencyEntry
	117, // 196: game.v1.CharacterSheetView.prepared_slots:type_name -> game.v1.PreparedSlotView
	122, // 197: game.v1.CharacterSheetView.spontaneous_use_pools:type_name -> game.v1.SpontaneousUsePoolView
	121, // 198: game.v1.CharacterSheetView.innate_slots:type_name -> game.v1.InnateSlotView
	118, // 199: game.v1.CharacterSheetView.hardwired_slots:type_name -> game.v1.HardwiredSlotView
	119, // 200: game.v1.CharacterSheetView.spontaneous_known:type_name -> game.v1.SpontaneousKnownEntry
	197, // 201: game.v1.CharacterSheetView.armor_categories:type_name -> game.v1.CharacterSheetView.ArmorCategoriesEntry
	125, // 202: game.v1.ProficienciesResponse.proficiencies:type_name -> game.v1.ProficiencyEntry
	191, // 203: game.v1.CraftResultEvent.materials_lost:type_name -> game.v1.MaterialLoss
	4,   // 204: game.v1.GameService.Session:input_type -> game.v1.ClientMessage
	32,  // 205: game.v1.GameService.Session:output_type -> game.v1.ServerEvent
	205, // [205:206] is the sub-list for method output_type
	204, // [204:205] is the sub-list for method input_type
