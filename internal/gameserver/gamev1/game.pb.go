...
const file_game_v1_game_proto_rawDesc = "" +
	"\n" +
	"\x12game/v1/game.proto\x12\agame.v1\"\xba\"\n" +
	...
	"\x04rest\x18Q \x01(\v2\x14.game.v1.RestRequestH\x00R\x04restB\t\n" +
	"\apayload\"\r\n" +
	"\vRestRequest\"\xea\v\n" +
...
var file_game_v1_game_proto_msgTypes = make([]protoimpl.MessageInfo, 121)
var file_game_v1_game_proto_goTypes = []any{
	...
	(*ServerEvent)(nil),               // 6: game.v1.ServerEvent
	(*HpUpdateEvent)(nil),             // 7: game.v1.HpUpdateEvent
	(*JoinWorldRequest)(nil),          // 8: game.v1.JoinWorldRequest
	(*MoveRequest)(nil),               // 9: game.v1.MoveRequest
	(*LookRequest)(nil),               // 10: game.v1.LookRequest
	(*SayRequest)(nil),                // 11: game.v1.SayRequest
	(*EmoteRequest)(nil),              // 12: game.v1.EmoteRequest
	(*WhoRequest)(nil),                // 13: game.v1.WhoRequest
	(*ExitsRequest)(nil),              // 14: game.v1.ExitsRequest
	(*QuitRequest)(nil),               // 15: game.v1.QuitRequest
	(*SwitchCharacterRequest)(nil),    // 16: game.v1.SwitchCharacterRequest
	(*RoomView)(nil),                  // 17: game.v1.RoomView
	(*ExitInfo)(nil),                  // 18: game.v1.ExitInfo
	(*MessageEvent)(nil),              // 19: game.v1.MessageEvent
	(*RoomEvent)(nil),                 // 20: game.v1.RoomEvent
	(*PlayerList)(nil),                // 21: game.v1.PlayerList
	(*PlayerInfo)(nil),                // 22: game.v1.PlayerInfo
	(*ExitList)(nil),                  // 23: game.v1.ExitList
	(*ErrorEvent)(nil),                // 24: game.v1.ErrorEvent
	(*Disconnected)(nil),              // 25: game.v1.Disconnected
	(*TimeOfDayEvent)(nil),            // 26: game.v1.TimeOfDayEvent
	(*CharacterInfo)(nil),             // 27: game.v1.CharacterInfo
	(*NpcInfo)(nil),                   // 28: game.v1.NpcInfo
	(*ExamineRequest)(nil),            // 29: game.v1.ExamineRequest
	(*NpcView)(nil),                   // 30: game.v1.NpcView
	(*AttackRequest)(nil),             // 31: game.v1.AttackRequest
	(*FleeRequest)(nil),               // 32: game.v1.FleeRequest
	(*PassRequest)(nil),               // 33: game.v1.PassRequest
	(*StrikeRequest)(nil),             // 34: game.v1.StrikeRequest
	(*EquipRequest)(nil),              // 35: game.v1.EquipRequest
	(*ReloadRequest)(nil),             // 36: game.v1.ReloadRequest
	(*FireBurstRequest)(nil),          // 37: game.v1.FireBurstRequest
	(*FireAutomaticRequest)(nil),      // 38: game.v1.FireAutomaticRequest
	(*ThrowRequest)(nil),              // 39: game.v1.ThrowRequest
	(*InventoryRequest)(nil),          // 40: game.v1.InventoryRequest
	(*GetItemRequest)(nil),            // 41: game.v1.GetItemRequest
	(*DropItemRequest)(nil),           // 42: game.v1.DropItemRequest
	(*BalanceRequest)(nil),            // 43: game.v1.BalanceRequest
	(*SetRoleRequest)(nil),            // 44: game.v1.SetRoleRequest
	(*LoadoutRequest)(nil),            // 45: game.v1.LoadoutRequest
	(*UnequipRequest)(nil),            // 46: game.v1.UnequipRequest
	(*EquipmentRequest)(nil),          // 47: game.v1.EquipmentRequest
	(*TeleportRequest)(nil),           // 48: game.v1.TeleportRequest
	(*SummonItemRequest)(nil),         // 49: game.v1.SummonItemRequest
	(*FloorItem)(nil),                 // 50: game.v1.FloorItem
	(*RoomEquipmentItem)(nil),         // 51: game.v1.RoomEquipmentItem
	(*UseEquipmentRequest)(nil),       // 52: game.v1.UseEquipmentRequest
	(*MapRequest)(nil),                // 53: game.v1.MapRequest
	(*MapTile)(nil),                   // 54: game.v1.MapTile
	(*MapResponse)(nil),               // 55: game.v1.MapResponse
	(*SkillsRequest)(nil),             // 56: game.v1.SkillsRequest
	(*SkillEntry)(nil),                // 57: game.v1.SkillEntry
	(*SkillsResponse)(nil),            // 58: game.v1.SkillsResponse
	(*RoomEquipRequest)(nil),          // 59: game.v1.RoomEquipRequest
	(*InventoryItem)(nil),             // 60: game.v1.InventoryItem
	(*InventoryView)(nil),             // 61: game.v1.InventoryView
	(*RoundStartEvent)(nil),           // 62: game.v1.RoundStartEvent
	(*RoundEndEvent)(nil),             // 63: game.v1.RoundEndEvent
	(*CombatEvent)(nil),               // 64: game.v1.CombatEvent
	(*StatusRequest)(nil),             // 65: game.v1.StatusRequest
	(*ConditionEvent)(nil),            // 66: game.v1.ConditionEvent
	(*WearRequest)(nil),               // 67: game.v1.WearRequest
	(*RemoveArmorRequest)(nil),        // 68: game.v1.RemoveArmorRequest
	(*ConditionInfo)(nil),             // 69: game.v1.ConditionInfo
	(*CharacterSheetRequest)(nil),     // 70: game.v1.CharacterSheetRequest
	(*ArchetypeSelectionRequest)(nil), // 71: game.v1.ArchetypeSelectionRequest
	(*FeatsRequest)(nil),              // 72: game.v1.FeatsRequest
	(*FeatEntry)(nil),                 // 73: game.v1.FeatEntry
	(*FeatsResponse)(nil),             // 74: game.v1.FeatsResponse
	(*ClassFeaturesRequest)(nil),      // 75: game.v1.ClassFeaturesRequest
	(*ClassFeatureEntry)(nil),         // 76: game.v1.ClassFeatureEntry
	(*ClassFeaturesResponse)(nil),     // 77: game.v1.ClassFeaturesResponse
	(*InteractRequest)(nil),           // 78: game.v1.InteractRequest
	(*InteractResponse)(nil),          // 79: game.v1.InteractResponse
	(*UseRequest)(nil),                // 80: game.v1.UseRequest
	(*UseResponse)(nil),               // 81: game.v1.UseResponse
	(*CharacterSheetView)(nil),        // 82: game.v1.CharacterSheetView
	(*ResistanceEntry)(nil),           // 83: game.v1.ResistanceEntry
	(*ProficienciesRequest)(nil),      // 84: game.v1.ProficienciesRequest
	(*ProficiencyEntry)(nil),          // 85: game.v1.ProficiencyEntry
	(*ProficienciesResponse)(nil),     // 86: game.v1.ProficienciesResponse
	(*LevelUpRequest)(nil),            // 87: game.v1.LevelUpRequest
	(*CombatDefaultRequest)(nil),      // 88: game.v1.CombatDefaultRequest
	(*TrainSkillRequest)(nil),         // 89: game.v1.TrainSkillRequest
	(*ActionRequest)(nil),             // 90: game.v1.ActionRequest
	(*RaiseShieldRequest)(nil),        // 91: game.v1.RaiseShieldRequest
	(*TakeCoverRequest)(nil),          // 92: game.v1.TakeCoverRequest
	(*FirstAidRequest)(nil),           // 93: game.v1.FirstAidRequest
	(*FeintRequest)(nil),              // 94: game.v1.FeintRequest
	(*DemoralizeRequest)(nil),         // 95: game.v1.DemoralizeRequest
	(*GrappleRequest)(nil),            // 96: game.v1.GrappleRequest
	(*TripRequest)(nil),               // 97: game.v1.TripRequest
	(*DisarmRequest)(nil),             // 98: game.v1.DisarmRequest
	(*StrideRequest)(nil),             // 99: game.v1.StrideRequest
	(*ShoveRequest)(nil),              // 100: game.v1.ShoveRequest
	(*StepRequest)(nil),               // 101: game.v1.StepRequest
	(*HideRequest)(nil),               // 102: game.v1.HideRequest
	(*SneakRequest)(nil),              // 103: game.v1.SneakRequest
	(*DivertRequest)(nil),             // 104: game.v1.DivertRequest
	(*EscapeRequest)(nil),             // 105: game.v1.EscapeRequest
	(*TumbleRequest)(nil),             // 106: game.v1.TumbleRequest
	(*SeekRequest)(nil),               // 107: game.v1.SeekRequest
	(*ClimbRequest)(nil),              // 108: game.v1.ClimbRequest
	(*SwimRequest)(nil),               // 109: game.v1.SwimRequest
	(*CalmRequest)(nil),               // 110: game.v1.CalmRequest
	(*HeroPointRequest)(nil),          // 111: game.v1.HeroPointRequest
	(*DelayRequest)(nil),              // 112: game.v1.DelayRequest
	(*JoinRequest)(nil),               // 113: game.v1.JoinRequest
	(*DeclineRequest)(nil),            // 114: game.v1.DeclineRequest
	(*GroupRequest)(nil),              // 115: game.v1.GroupRequest
	(*InviteRequest)(nil),             // 116: game.v1.InviteRequest
	(*AcceptGroupRequest)(nil),        // 117: game.v1.AcceptGroupRequest
	(*DeclineGroupRequest)(nil),       // 118: game.v1.DeclineGroupRequest
	(*UngroupRequest)(nil),            // 119: game.v1.UngroupRequest
	(*KickRequest)(nil),               // 120: game.v1.KickRequest
	(*MotiveRequest)(nil),             // 121: game.v1.MotiveRequest
	(*GrantRequest)(nil),              // 122: game.v1.GrantRequest
	nil,                               // 123: game.v1.CharacterSheetView.ArmorEntry
	nil,                               // 124: game.v1.CharacterSheetView.AccessoriesEntry
}
var file_game_v1_game_proto_depIdxs = []int32{
	8,   // 0: game.v1.ClientMessage.join_world:type_name -> game.v1.JoinWorldRequest
	9,   // 1: game.v1.ClientMessage.move:type_name -> game.v1.MoveRequest
	10,  // 2: game.v1.ClientMessage.look:type_name -> game.v1.LookRequest
	11,  // 3: game.v1.ClientMessage.say:type_name -> game.v1.SayRequest
	12,  // 4: game.v1.ClientMessage.emote:type_name -> game.v1.EmoteRequest
	13,  // 5: game.v1.ClientMessage.who:type_name -> game.v1.WhoRequest
	14,  // 6: game.v1.ClientMessage.exits:type_name -> game.v1.ExitsRequest
	15,  // 7: game.v1.ClientMessage.quit:type_name -> game.v1.QuitRequest
	29,  // 8: game.v1.ClientMessage.examine:type_name -> game.v1.ExamineRequest
	31,  // 9: game.v1.ClientMessage.attack:type_name -> game.v1.AttackRequest
	32,  // 10: game.v1.ClientMessage.flee:type_name -> game.v1.FleeRequest
	33,  // 11: game.v1.ClientMessage.pass:type_name -> game.v1.PassRequest
	34,  // 12: game.v1.ClientMessage.strike:type_name -> game.v1.StrikeRequest
	65,  // 13: game.v1.ClientMessage.status:type_name -> game.v1.StatusRequest
	35,  // 14: game.v1.ClientMessage.equip:type_name -> game.v1.EquipRequest
	36,  // 15: game.v1.ClientMessage.reload:type_name -> game.v1.ReloadRequest
	37,  // 16: game.v1.ClientMessage.fire_burst:type_name -> game.v1.FireBurstRequest
	38,  // 17: game.v1.ClientMessage.fire_automatic:type_name -> game.v1.FireAutomaticRequest
	39,  // 18: game.v1.ClientMessage.throw:type_name -> game.v1.ThrowRequest
	40,  // 19: game.v1.ClientMessage.inventory_req:type_name -> game.v1.InventoryRequest
	41,  // 20: game.v1.ClientMessage.get_item:type_name -> game.v1.GetItemRequest
	42,  // 21: game.v1.ClientMessage.drop_item:type_name -> game.v1.DropItemRequest
	43,  // 22: game.v1.ClientMessage.balance:type_name -> game.v1.BalanceRequest
	44,  // 23: game.v1.ClientMessage.set_role:type_name -> game.v1.SetRoleRequest
	48,  // 24: game.v1.ClientMessage.teleport:type_name -> game.v1.TeleportRequest
	45,  // 25: game.v1.ClientMessage.loadout:type_name -> game.v1.LoadoutRequest
	46,  // 26: game.v1.ClientMessage.unequip:type_name -> game.v1.UnequipRequest
	47,  // 27: game.v1.ClientMessage.equipment:type_name -> game.v1.EquipmentRequest
	16,  // 28: game.v1.ClientMessage.switch_character:type_name -> game.v1.SwitchCharacterRequest
	67,  // 29: game.v1.ClientMessage.wear:type_name -> game.v1.WearRequest
	68,  // 30: game.v1.ClientMessage.remove_armor:type_name -> game.v1.RemoveArmorRequest
	70,  // 31: game.v1.ClientMessage.char_sheet:type_name -> game.v1.CharacterSheetRequest
	71,  // 32: game.v1.ClientMessage.archetype_selection:type_name -> game.v1.ArchetypeSelectionRequest
	52,  // 33: game.v1.ClientMessage.use_equipment:type_name -> game.v1.UseEquipmentRequest
	59,  // 34: game.v1.ClientMessage.room_equip:type_name -> game.v1.RoomEquipRequest
	53,  // 35: game.v1.ClientMessage.map:type_name -> game.v1.MapRequest
	56,  // 36: game.v1.ClientMessage.skills_request:type_name -> game.v1.SkillsRequest
	72,  // 37: game.v1.ClientMessage.feats_request:type_name -> game.v1.FeatsRequest
	78,  // 38: game.v1.ClientMessage.interact_request:type_name -> game.v1.InteractRequest
	80,  // 39: game.v1.ClientMessage.use_request:type_name -> game.v1.UseRequest
	75,  // 40: game.v1.ClientMessage.class_features_request:type_name -> game.v1.ClassFeaturesRequest
	49,  // 41: game.v1.ClientMessage.summon_item:type_name -> game.v1.SummonItemRequest
	84,  // 42: game.v1.ClientMessage.proficiencies_request:type_name -> game.v1.ProficienciesRequest
	87,  // 43: game.v1.ClientMessage.level_up:type_name -> game.v1.LevelUpRequest
	88,  // 44: game.v1.ClientMessage.combat_default:type_name -> game.v1.CombatDefaultRequest
	89,  // 45: game.v1.ClientMessage.train_skill:type_name -> game.v1.TrainSkillRequest
	90,  // 46: game.v1.ClientMessage.action:type_name -> game.v1.ActionRequest
	91,  // 47: game.v1.ClientMessage.raise_shield:type_name -> game.v1.RaiseShieldRequest
	92,  // 48: game.v1.ClientMessage.take_cover:type_name -> game.v1.TakeCoverRequest
	93,  // 49: game.v1.ClientMessage.first_aid:type_name -> game.v1.FirstAidRequest
	94,  // 50: game.v1.ClientMessage.feint:type_name -> game.v1.FeintRequest
	95,  // 51: game.v1.ClientMessage.demoralize:type_name -> game.v1.DemoralizeRequest
	96,  // 52: game.v1.ClientMessage.grapple:type_name -> game.v1.GrappleRequest
	97,  // 53: game.v1.ClientMessage.trip:type_name -> game.v1.TripRequest
	102, // 54: game.v1.ClientMessage.hide:type_name -> game.v1.HideRequest
	103, // 55: game.v1.ClientMessage.sneak:type_name -> game.v1.SneakRequest
	104, // 56: game.v1.ClientMessage.divert:type_name -> game.v1.DivertRequest
	105, // 57: game.v1.ClientMessage.escape:type_name -> game.v1.EscapeRequest
	122, // 58: game.v1.ClientMessage.grant:type_name -> game.v1.GrantRequest
	98,  // 59: game.v1.ClientMessage.disarm:type_name -> game.v1.DisarmRequest
	99,  // 60: game.v1.ClientMessage.stride:type_name -> game.v1.StrideRequest
	100, // 61: game.v1.ClientMessage.shove:type_name -> game.v1.ShoveRequest
	101, // 62: game.v1.ClientMessage.step:type_name -> game.v1.StepRequest
	106, // 63: game.v1.ClientMessage.tumble:type_name -> game.v1.TumbleRequest
	107, // 64: game.v1.ClientMessage.seek:type_name -> game.v1.SeekRequest
	108, // 65: game.v1.ClientMessage.climb:type_name -> game.v1.ClimbRequest
	109, // 66: game.v1.ClientMessage.swim:type_name -> game.v1.SwimRequest
	121, // 67: game.v1.ClientMessage.motive:type_name -> game.v1.MotiveRequest
	110, // 68: game.v1.ClientMessage.calm:type_name -> game.v1.CalmRequest
	111, // 69: game.v1.ClientMessage.hero_point:type_name -> game.v1.HeroPointRequest
	112, // 70: game.v1.ClientMessage.delay:type_name -> game.v1.DelayRequest
	113, // 71: game.v1.ClientMessage.join:type_name -> game.v1.JoinRequest
	114, // 72: game.v1.ClientMessage.decline:type_name -> game.v1.DeclineRequest
	115, // 73: game.v1.ClientMessage.group:type_name -> game.v1.GroupRequest
	116, // 74: game.v1.ClientMessage.invite:type_name -> game.v1.InviteRequest
	117, // 75: game.v1.ClientMessage.accept_group:type_name -> game.v1.AcceptGroupRequest
	118, // 76: game.v1.ClientMessage.decline_group:type_name -> game.v1.DeclineGroupRequest
	119, // 77: game.v1.ClientMessage.ungroup:type_name -> game.v1.UngroupRequest
	120, // 78: game.v1.ClientMessage.kick:type_name -> game.v1.KickRequest
	5,   // 79: game.v1.ClientMessage.rest:type_name -> game.v1.RestRequest
	17,  // 80: game.v1.ServerEvent.room_view:type_name -> game.v1.RoomView
	19,  // 81: game.v1.ServerEvent.message:type_name -> game.v1.MessageEvent
	20,  // 82: game.v1.ServerEvent.room_event:type_name -> game.v1.RoomEvent
	21,  // 83: game.v1.ServerEvent.player_list:type_name -> game.v1.PlayerList
	23,  // 84: game.v1.ServerEvent.exit_list:type_name -> game.v1.ExitList
	24,  // 85: game.v1.ServerEvent.error:type_name -> game.v1.ErrorEvent
	25,  // 86: game.v1.ServerEvent.disconnected:type_name -> game.v1.Disconnected
	27,  // 87: game.v1.ServerEvent.character_info:type_name -> game.v1.CharacterInfo
	30,  // 88: game.v1.ServerEvent.npc_view:type_name -> game.v1.NpcView
	64,  // 89: game.v1.ServerEvent.combat_event:type_name -> game.v1.CombatEvent
	62,  // 90: game.v1.ServerEvent.round_start:type_name -> game.v1.RoundStartEvent
	63,  // 91: game.v1.ServerEvent.round_end:type_name -> game.v1.RoundEndEvent
	66,  // 92: game.v1.ServerEvent.condition_event:type_name -> game.v1.ConditionEvent
	61,  // 93: game.v1.ServerEvent.inventory_view:type_name -> game.v1.InventoryView
	26,  // 94: game.v1.ServerEvent.time_of_day:type_name -> game.v1.TimeOfDayEvent
	82,  // 95: game.v1.ServerEvent.character_sheet:type_name -> game.v1.CharacterSheetView
	55,  // 96: game.v1.ServerEvent.map:type_name -> game.v1.MapResponse
	58,  // 97: game.v1.ServerEvent.skills_response:type_name -> game.v1.SkillsResponse
	74,  // 98: game.v1.ServerEvent.feats_response:type_name -> game.v1.FeatsResponse
	79,  // 99: game.v1.ServerEvent.interact_response:type_name -> game.v1.InteractResponse
	81,  // 100: game.v1.ServerEvent.use_response:type_name -> game.v1.UseResponse
	77,  // 101: game.v1.ServerEvent.class_features_response:type_name -> game.v1.ClassFeaturesResponse
	86,  // 102: game.v1.ServerEvent.proficiencies_response:type_name -> game.v1.ProficienciesResponse
	7,   // 103: game.v1.ServerEvent.hp_update:type_name -> game.v1.HpUpdateEvent
	18,  // 104: game.v1.RoomView.exits:type_name -> game.v1.ExitInfo
	28,  // 105: game.v1.RoomView.npcs:type_name -> game.v1.NpcInfo
	69,  // 106: game.v1.RoomView.active_conditions:type_name -> game.v1.ConditionInfo
	50,  // 107: game.v1.RoomView.floor_items:type_name -> game.v1.FloorItem
	51,  // 108: game.v1.RoomView.equipment:type_name -> game.v1.RoomEquipmentItem
	0,   // 109: game.v1.MessageEvent.type:type_name -> game.v1.MessageType
	1,   // 110: game.v1.RoomEvent.type:type_name -> game.v1.RoomEventType
	22,  // 111: game.v1.PlayerList.players:type_name -> game.v1.PlayerInfo
	2,   // 112: game.v1.PlayerInfo.status:type_name -> game.v1.CombatStatus
	18,  // 113: game.v1.ExitList.exits:type_name -> game.v1.ExitInfo
	54,  // 114: game.v1.MapResponse.tiles:type_name -> game.v1.MapTile
	57,  // 115: game.v1.SkillsResponse.skills:type_name -> game.v1.SkillEntry
	60,  // 116: game.v1.InventoryView.items:type_name -> game.v1.InventoryItem
	3,   // 117: game.v1.CombatEvent.type:type_name -> game.v1.CombatEventType
	73,  // 118: game.v1.FeatsResponse.feats:type_name -> game.v1.FeatEntry
	76,  // 119: game.v1.ClassFeaturesResponse.archetype_features:type_name -> game.v1.ClassFeatureEntry
	76,  // 120: game.v1.ClassFeaturesResponse.job_features:type_name -> game.v1.ClassFeatureEntry
	73,  // 121: game.v1.UseResponse.choices:type_name -> game.v1.FeatEntry
	123, // 122: game.v1.CharacterSheetView.armor:type_name -> game.v1.CharacterSheetView.ArmorEntry
	124, // 123: game.v1.CharacterSheetView.accessories:type_name -> game.v1.CharacterSheetView.AccessoriesEntry
	83,  // 124: game.v1.CharacterSheetView.player_resistances:type_name -> game.v1.ResistanceEntry
	83,  // 125: game.v1.CharacterSheetView.player_weaknesses:type_name -> game.v1.ResistanceEntry
	57,  // 126: game.v1.CharacterSheetView.skills:type_name -> game.v1.SkillEntry
	73,  // 127: game.v1.CharacterSheetView.feats:type_name -> game.v1.FeatEntry
	76,  // 128: game.v1.CharacterSheetView.class_features:type_name -> game.v1.ClassFeatureEntry
	85,  // 129: game.v1.CharacterSheetView.proficiencies:type_name -> game.v1.ProficiencyEntry
	85,  // 130: game.v1.ProficienciesResponse.proficiencies:type_name -> game.v1.ProficiencyEntry
	4,   // 131: game.v1.GameService.Session:input_type -> game.v1.ClientMessage
	6,   // 132: game.v1.GameService.Session:output_type -> game.v1.ServerEvent
