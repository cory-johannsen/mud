...
const file_game_v1_game_proto_rawDesc = "" +
	...
	"\achoices\x18\x02 \x03(\v2\x12.game.v1.FeatEntryR\achoices\"\xe4\r\n" +
	...
	"heroPoints\x126\n" +
	"\x17pending_tech_selections\x18+ \x01(\x05R\x15pendingTechSelections\x1a8\n" +
	"\n" +
	"ArmorEntry\x12\x10\n" +
...
var file_game_v1_game_proto_msgTypes = make([]protoimpl.MessageInfo, 122)
var file_game_v1_game_proto_goTypes = []any{
	...
	(*CharacterSheetView)(nil),        // 83: game.v1.CharacterSheetView
	(*ResistanceEntry)(nil),           // 84: game.v1.ResistanceEntry
	(*ProficienciesRequest)(nil),      // 85: game.v1.ProficienciesRequest
	(*ProficiencyEntry)(nil),          // 86: game.v1.ProficiencyEntry
	(*ProficienciesResponse)(nil),     // 87: game.v1.ProficienciesResponse
	(*LevelUpRequest)(nil),            // 88: game.v1.LevelUpRequest
	(*CombatDefaultRequest)(nil),      // 89: game.v1.CombatDefaultRequest
	(*TrainSkillRequest)(nil),         // 90: game.v1.TrainSkillRequest
	(*ActionRequest)(nil),             // 91: game.v1.ActionRequest
	(*RaiseShieldRequest)(nil),        // 92: game.v1.RaiseShieldRequest
	(*TakeCoverRequest)(nil),          // 93: game.v1.TakeCoverRequest
	(*FirstAidRequest)(nil),           // 94: game.v1.FirstAidRequest
	(*FeintRequest)(nil),              // 95: game.v1.FeintRequest
	(*DemoralizeRequest)(nil),         // 96: game.v1.DemoralizeRequest
	(*GrappleRequest)(nil),            // 97: game.v1.GrappleRequest
	(*TripRequest)(nil),               // 98: game.v1.TripRequest
	(*DisarmRequest)(nil),             // 99: game.v1.DisarmRequest
	(*StrideRequest)(nil),             // 100: game.v1.StrideRequest
	(*ShoveRequest)(nil),              // 101: game.v1.ShoveRequest
	(*StepRequest)(nil),               // 102: game.v1.StepRequest
	(*HideRequest)(nil),               // 103: game.v1.HideRequest
	(*SneakRequest)(nil),              // 104: game.v1.SneakRequest
	(*DivertRequest)(nil),             // 105: game.v1.DivertRequest
	(*EscapeRequest)(nil),             // 106: game.v1.EscapeRequest
	(*TumbleRequest)(nil),             // 107: game.v1.TumbleRequest
	(*SeekRequest)(nil),               // 108: game.v1.SeekRequest
	(*ClimbRequest)(nil),              // 109: game.v1.ClimbRequest
	(*SwimRequest)(nil),               // 110: game.v1.SwimRequest
	(*CalmRequest)(nil),               // 111: game.v1.CalmRequest
	(*HeroPointRequest)(nil),          // 112: game.v1.HeroPointRequest
	(*DelayRequest)(nil),              // 113: game.v1.DelayRequest
	(*JoinRequest)(nil),               // 114: game.v1.JoinRequest
	(*DeclineRequest)(nil),            // 115: game.v1.DeclineRequest
	(*GroupRequest)(nil),              // 116: game.v1.GroupRequest
	(*InviteRequest)(nil),             // 117: game.v1.InviteRequest
	(*AcceptGroupRequest)(nil),        // 118: game.v1.AcceptGroupRequest
	(*DeclineGroupRequest)(nil),       // 119: game.v1.DeclineGroupRequest
	(*UngroupRequest)(nil),            // 120: game.v1.UngroupRequest
	(*KickRequest)(nil),               // 121: game.v1.KickRequest
	(*MotiveRequest)(nil),             // 122: game.v1.MotiveRequest
	(*GrantRequest)(nil),              // 123: game.v1.GrantRequest
	nil,                               // 124: game.v1.CharacterSheetView.ArmorEntry
	nil,                               // 125: game.v1.CharacterSheetView.AccessoriesEntry
}
var file_game_v1_game_proto_depIdxs = []int32{
	...
	85,  // 42: game.v1.ClientMessage.proficiencies_request:type_name -> game.v1.ProficienciesRequest
	88,  // 43: game.v1.ClientMessage.level_up:type_name -> game.v1.LevelUpRequest
	89,  // 44: game.v1.ClientMessage.combat_default:type_name -> game.v1.CombatDefaultRequest
	90,  // 45: game.v1.ClientMessage.train_skill:type_name -> game.v1.TrainSkillRequest
	91,  // 46: game.v1.ClientMessage.action:type_name -> game.v1.ActionRequest
	92,  // 47: game.v1.ClientMessage.raise_shield:type_name -> game.v1.RaiseShieldRequest
	93,  // 48: game.v1.ClientMessage.take_cover:type_name -> game.v1.TakeCoverRequest
	94,  // 49: game.v1.ClientMessage.first_aid:type_name -> game.v1.FirstAidRequest
	95,  // 50: game.v1.ClientMessage.feint:type_name -> game.v1.FeintRequest
	96,  // 51: game.v1.ClientMessage.demoralize:type_name -> game.v1.DemoralizeRequest
	97,  // 52: game.v1.ClientMessage.grapple:type_name -> game.v1.GrappleRequest
	98,  // 53: game.v1.ClientMessage.trip:type_name -> game.v1.TripRequest
	103, // 54: game.v1.ClientMessage.hide:type_name -> game.v1.HideRequest
	104, // 55: game.v1.ClientMessage.sneak:type_name -> game.v1.SneakRequest
	105, // 56: game.v1.ClientMessage.divert:type_name -> game.v1.DivertRequest
	106, // 57: game.v1.ClientMessage.escape:type_name -> game.v1.EscapeRequest
	123, // 58: game.v1.ClientMessage.grant:type_name -> game.v1.GrantRequest
	99,  // 59: game.v1.ClientMessage.disarm:type_name -> game.v1.DisarmRequest
	100, // 60: game.v1.ClientMessage.stride:type_name -> game.v1.StrideRequest
	101, // 61: game.v1.ClientMessage.shove:type_name -> game.v1.ShoveRequest
	102, // 62: game.v1.ClientMessage.step:type_name -> game.v1.StepRequest
	107, // 63: game.v1.ClientMessage.tumble:type_name -> game.v1.TumbleRequest
	108, // 64: game.v1.ClientMessage.seek:type_name -> game.v1.SeekRequest
	109, // 65: game.v1.ClientMessage.climb:type_name -> game.v1.ClimbRequest
	110, // 66: game.v1.ClientMessage.swim:type_name -> game.v1.SwimRequest
	122, // 67: game.v1.ClientMessage.motive:type_name -> game.v1.MotiveRequest
	111, // 68: game.v1.ClientMessage.calm:type_name -> game.v1.CalmRequest
	112, // 69: game.v1.ClientMessage.hero_point:type_name -> game.v1.HeroPointRequest
	113, // 70: game.v1.ClientMessage.delay:type_name -> game.v1.DelayRequest
	114, // 71: game.v1.ClientMessage.join:type_name -> game.v1.JoinRequest
	115, // 72: game.v1.ClientMessage.decline:type_name -> game.v1.DeclineRequest
	116, // 73: game.v1.ClientMessage.group:type_name -> game.v1.GroupRequest
	117, // 74: game.v1.ClientMessage.invite:type_name -> game.v1.InviteRequest
	118, // 75: game.v1.ClientMessage.accept_group:type_name -> game.v1.AcceptGroupRequest
	119, // 76: game.v1.ClientMessage.decline_group:type_name -> game.v1.DeclineGroupRequest
	120, // 77: game.v1.ClientMessage.ungroup:type_name -> game.v1.UngroupRequest
	121, // 78: game.v1.ClientMessage.kick:type_name -> game.v1.KickRequest
	...
	83,  // 96: game.v1.ServerEvent.character_sheet:type_name -> game.v1.CharacterSheetView
	...
	87,  // 103: game.v1.ServerEvent.proficiencies_response:type_name -> game.v1.ProficienciesResponse
	...
	124, // 123: game.v1.CharacterSheetView.armor:type_name -> game.v1.CharacterSheetView.ArmorEntry
	125, // 124: game.v1.CharacterSheetView.accessories:type_name -> game.v1.CharacterSheetView.AccessoriesEntry
	84,  // 125: game.v1.CharacterSheetView.player_resistances:type_name -> game.v1.ResistanceEntry
	84,  // 126: game.v1.CharacterSheetView.player_weaknesses:type_name -> game.v1.ResistanceEntry
	...
	86,  // 130: game.v1.CharacterSheetView.proficiencies:type_name -> game.v1.ProficiencyEntry
	86,  // 131: game.v1.ProficienciesResponse.proficiencies:type_name -> game.v1.ProficiencyEntry
	4,   // 132: game.v1.GameService.Session:input_type -> game.v1.ClientMessage
	7,   // 133: game.v1.GameService.Session:output_type -> game.v1.ServerEvent
