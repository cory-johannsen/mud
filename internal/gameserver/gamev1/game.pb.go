...
const file_game_v1_game_proto_rawDesc = "" +
	"\n" +
	"\x12game/v1/game.proto\x12\agame.v1\"\xe1#\n" +
	...
	"\ttrap_name\x18\x01 \x01(\tR\btrapName\"\xea\v\n" +
...
var file_game_v1_game_proto_msgTypes = make([]protoimpl.MessageInfo, 127)
var file_game_v1_game_proto_goTypes = []any{
	...
	(*ServerEvent)(nil),               // 9: game.v1.ServerEvent
	(*HpUpdateEvent)(nil),             // 10: game.v1.HpUpdateEvent
	(*JoinWorldRequest)(nil),          // 11: game.v1.JoinWorldRequest
	(*MoveRequest)(nil),               // 12: game.v1.MoveRequest
	(*LookRequest)(nil),               // 13: game.v1.LookRequest
	(*SayRequest)(nil),                // 14: game.v1.SayRequest
	(*EmoteRequest)(nil),              // 15: game.v1.EmoteRequest
	(*WhoRequest)(nil),                // 16: game.v1.WhoRequest
	(*ExitsRequest)(nil),              // 17: game.v1.ExitsRequest
	(*QuitRequest)(nil),               // 18: game.v1.QuitRequest
	(*SwitchCharacterRequest)(nil),    // 19: game.v1.SwitchCharacterRequest
	(*RoomView)(nil),                  // 20: game.v1.RoomView
	(*ExitInfo)(nil),                  // 21: game.v1.ExitInfo
	(*MessageEvent)(nil),              // 22: game.v1.MessageEvent
	(*RoomEvent)(nil),                 // 23: game.v1.RoomEvent
	(*PlayerList)(nil),                // 24: game.v1.PlayerList
	(*PlayerInfo)(nil),                // 25: game.v1.PlayerInfo
	(*ExitList)(nil),                  // 26: game.v1.ExitList
	(*ErrorEvent)(nil),                // 27: game.v1.ErrorEvent
	(*Disconnected)(nil),              // 28: game.v1.Disconnected
	(*TimeOfDayEvent)(nil),            // 29: game.v1.TimeOfDayEvent
	(*CharacterInfo)(nil),             // 30: game.v1.CharacterInfo
	(*NpcInfo)(nil),                   // 31: game.v1.NpcInfo
	(*ExamineRequest)(nil),            // 32: game.v1.ExamineRequest
	(*NpcView)(nil),                   // 33: game.v1.NpcView
	(*AttackRequest)(nil),             // 34: game.v1.AttackRequest
	(*FleeRequest)(nil),               // 35: game.v1.FleeRequest
	(*PassRequest)(nil),               // 36: game.v1.PassRequest
	(*StrikeRequest)(nil),             // 37: game.v1.StrikeRequest
	(*EquipRequest)(nil),              // 38: game.v1.EquipRequest
	(*ReloadRequest)(nil),             // 39: game.v1.ReloadRequest
	(*FireBurstRequest)(nil),          // 40: game.v1.FireBurstRequest
	(*FireAutomaticRequest)(nil),      // 41: game.v1.FireAutomaticRequest
	(*ThrowRequest)(nil),              // 42: game.v1.ThrowRequest
	(*InventoryRequest)(nil),          // 43: game.v1.InventoryRequest
	(*GetItemRequest)(nil),            // 44: game.v1.GetItemRequest
	(*DropItemRequest)(nil),           // 45: game.v1.DropItemRequest
	(*BalanceRequest)(nil),            // 46: game.v1.BalanceRequest
	(*SetRoleRequest)(nil),            // 47: game.v1.SetRoleRequest
	(*LoadoutRequest)(nil),            // 48: game.v1.LoadoutRequest
	(*UnequipRequest)(nil),            // 49: game.v1.UnequipRequest
	(*EquipmentRequest)(nil),          // 50: game.v1.EquipmentRequest
	(*TeleportRequest)(nil),           // 51: game.v1.TeleportRequest
	(*SummonItemRequest)(nil),         // 52: game.v1.SummonItemRequest
	(*FloorItem)(nil),                 // 53: game.v1.FloorItem
	(*RoomEquipmentItem)(nil),         // 54: game.v1.RoomEquipmentItem
	(*UseEquipmentRequest)(nil),       // 55: game.v1.UseEquipmentRequest
	(*MapRequest)(nil),                // 56: game.v1.MapRequest
	(*MapTile)(nil),                   // 57: game.v1.MapTile
	(*MapResponse)(nil),               // 58: game.v1.MapResponse
	(*SkillsRequest)(nil),             // 59: game.v1.SkillsRequest
	(*SkillEntry)(nil),                // 60: game.v1.SkillEntry
	(*SkillsResponse)(nil),            // 61: game.v1.SkillsResponse
	(*RoomEquipRequest)(nil),          // 62: game.v1.RoomEquipRequest
	(*InventoryItem)(nil),             // 63: game.v1.InventoryItem
	(*InventoryView)(nil),             // 64: game.v1.InventoryView
	(*RoundStartEvent)(nil),           // 65: game.v1.RoundStartEvent
	(*RoundEndEvent)(nil),             // 66: game.v1.RoundEndEvent
	(*CombatEvent)(nil),               // 67: game.v1.CombatEvent
	(*StatusRequest)(nil),             // 68: game.v1.StatusRequest
	(*ConditionEvent)(nil),            // 69: game.v1.ConditionEvent
	(*WearRequest)(nil),               // 70: game.v1.WearRequest
	(*RemoveArmorRequest)(nil),        // 71: game.v1.RemoveArmorRequest
	(*ConditionInfo)(nil),             // 72: game.v1.ConditionInfo
	(*CharacterSheetRequest)(nil),     // 73: game.v1.CharacterSheetRequest
	(*ArchetypeSelectionRequest)(nil), // 74: game.v1.ArchetypeSelectionRequest
	(*FeatsRequest)(nil),              // 75: game.v1.FeatsRequest
	(*FeatEntry)(nil),                 // 76: game.v1.FeatEntry
	(*FeatsResponse)(nil),             // 77: game.v1.FeatsResponse
	(*ClassFeaturesRequest)(nil),      // 78: game.v1.ClassFeaturesRequest
	(*ClassFeatureEntry)(nil),         // 79: game.v1.ClassFeatureEntry
	(*ClassFeaturesResponse)(nil),     // 80: game.v1.ClassFeaturesResponse
	(*InteractRequest)(nil),           // 81: game.v1.InteractRequest
	(*InteractResponse)(nil),          // 82: game.v1.InteractResponse
	(*UseRequest)(nil),                // 83: game.v1.UseRequest
	(*UseResponse)(nil),               // 84: game.v1.UseResponse
	(*PreparedSlotView)(nil),          // 85: game.v1.PreparedSlotView
	(*CharacterSheetView)(nil),        // 86: game.v1.CharacterSheetView
	(*InnateSlotView)(nil),            // 87: game.v1.InnateSlotView
	(*SpontaneousUsePoolView)(nil),    // 88: game.v1.SpontaneousUsePoolView
	(*ResistanceEntry)(nil),           // 89: game.v1.ResistanceEntry
	(*ProficienciesRequest)(nil),      // 90: game.v1.ProficienciesRequest
	(*ProficiencyEntry)(nil),          // 91: game.v1.ProficiencyEntry
	(*ProficienciesResponse)(nil),     // 92: game.v1.ProficienciesResponse
	(*LevelUpRequest)(nil),            // 93: game.v1.LevelUpRequest
	(*CombatDefaultRequest)(nil),      // 94: game.v1.CombatDefaultRequest
	(*TrainSkillRequest)(nil),         // 95: game.v1.TrainSkillRequest
	(*ActionRequest)(nil),             // 96: game.v1.ActionRequest
	(*RaiseShieldRequest)(nil),        // 97: game.v1.RaiseShieldRequest
	(*TakeCoverRequest)(nil),          // 98: game.v1.TakeCoverRequest
	(*FirstAidRequest)(nil),           // 99: game.v1.FirstAidRequest
	(*FeintRequest)(nil),              // 100: game.v1.FeintRequest
	(*DemoralizeRequest)(nil),         // 101: game.v1.DemoralizeRequest
	(*GrappleRequest)(nil),            // 102: game.v1.GrappleRequest
	(*TripRequest)(nil),               // 103: game.v1.TripRequest
	(*DisarmRequest)(nil),             // 104: game.v1.DisarmRequest
	(*StrideRequest)(nil),             // 105: game.v1.StrideRequest
	(*ShoveRequest)(nil),              // 106: game.v1.ShoveRequest
	(*StepRequest)(nil),               // 107: game.v1.StepRequest
	(*HideRequest)(nil),               // 108: game.v1.HideRequest
	(*SneakRequest)(nil),              // 109: game.v1.SneakRequest
	(*DivertRequest)(nil),             // 110: game.v1.DivertRequest
	(*EscapeRequest)(nil),             // 111: game.v1.EscapeRequest
	(*TumbleRequest)(nil),             // 112: game.v1.TumbleRequest
	(*SeekRequest)(nil),               // 113: game.v1.SeekRequest
	(*ClimbRequest)(nil),              // 114: game.v1.ClimbRequest
	(*SwimRequest)(nil),               // 115: game.v1.SwimRequest
	(*CalmRequest)(nil),               // 116: game.v1.CalmRequest
	(*HeroPointRequest)(nil),          // 117: game.v1.HeroPointRequest
	(*DelayRequest)(nil),              // 118: game.v1.DelayRequest
	(*JoinRequest)(nil),               // 119: game.v1.JoinRequest
	(*DeclineRequest)(nil),            // 120: game.v1.DeclineRequest
	(*GroupRequest)(nil),              // 121: game.v1.GroupRequest
	(*InviteRequest)(nil),             // 122: game.v1.InviteRequest
	(*AcceptGroupRequest)(nil),        // 123: game.v1.AcceptGroupRequest
	(*DeclineGroupRequest)(nil),       // 124: game.v1.DeclineGroupRequest
	(*UngroupRequest)(nil),            // 125: game.v1.UngroupRequest
	(*KickRequest)(nil),               // 126: game.v1.KickRequest
	(*MotiveRequest)(nil),             // 127: game.v1.MotiveRequest
	(*GrantRequest)(nil),              // 128: game.v1.GrantRequest
	nil,                               // 129: game.v1.CharacterSheetView.ArmorEntry
	nil,                               // 130: game.v1.CharacterSheetView.AccessoriesEntry
}
var file_game_v1_game_proto_depIdxs = []int32{
	11,  // 0: game.v1.ClientMessage.join_world:type_name -> game.v1.JoinWorldRequest
	12,  // 1: game.v1.ClientMessage.move:type_name -> game.v1.MoveRequest
	13,  // 2: game.v1.ClientMessage.look:type_name -> game.v1.LookRequest
	14,  // 3: game.v1.ClientMessage.say:type_name -> game.v1.SayRequest
	15,  // 4: game.v1.ClientMessage.emote:type_name -> game.v1.EmoteRequest
	16,  // 5: game.v1.ClientMessage.who:type_name -> game.v1.WhoRequest
	17,  // 6: game.v1.ClientMessage.exits:type_name -> game.v1.ExitsRequest
	18,  // 7: game.v1.ClientMessage.quit:type_name -> game.v1.QuitRequest
	32,  // 8: game.v1.ClientMessage.examine:type_name -> game.v1.ExamineRequest
	34,  // 9: game.v1.ClientMessage.attack:type_name -> game.v1.AttackRequest
	35,  // 10: game.v1.ClientMessage.flee:type_name -> game.v1.FleeRequest
	36,  // 11: game.v1.ClientMessage.pass:type_name -> game.v1.PassRequest
	37,  // 12: game.v1.ClientMessage.strike:type_name -> game.v1.StrikeRequest
	68,  // 13: game.v1.ClientMessage.status:type_name -> game.v1.StatusRequest
	38,  // 14: game.v1.ClientMessage.equip:type_name -> game.v1.EquipRequest
	39,  // 15: game.v1.ClientMessage.reload:type_name -> game.v1.ReloadRequest
	40,  // 16: game.v1.ClientMessage.fire_burst:type_name -> game.v1.FireBurstRequest
	41,  // 17: game.v1.ClientMessage.fire_automatic:type_name -> game.v1.FireAutomaticRequest
	42,  // 18: game.v1.ClientMessage.throw:type_name -> game.v1.ThrowRequest
	43,  // 19: game.v1.ClientMessage.inventory_req:type_name -> game.v1.InventoryRequest
	44,  // 20: game.v1.ClientMessage.get_item:type_name -> game.v1.GetItemRequest
	45,  // 21: game.v1.ClientMessage.drop_item:type_name -> game.v1.DropItemRequest
	46,  // 22: game.v1.ClientMessage.balance:type_name -> game.v1.BalanceRequest
	47,  // 23: game.v1.ClientMessage.set_role:type_name -> game.v1.SetRoleRequest
	51,  // 24: game.v1.ClientMessage.teleport:type_name -> game.v1.TeleportRequest
	48,  // 25: game.v1.ClientMessage.loadout:type_name -> game.v1.LoadoutRequest
	49,  // 26: game.v1.ClientMessage.unequip:type_name -> game.v1.UnequipRequest
	50,  // 27: game.v1.ClientMessage.equipment:type_name -> game.v1.EquipmentRequest
	19,  // 28: game.v1.ClientMessage.switch_character:type_name -> game.v1.SwitchCharacterRequest
	70,  // 29: game.v1.ClientMessage.wear:type_name -> game.v1.WearRequest
	71,  // 30: game.v1.ClientMessage.remove_armor:type_name -> game.v1.RemoveArmorRequest
	73,  // 31: game.v1.ClientMessage.char_sheet:type_name -> game.v1.CharacterSheetRequest
	74,  // 32: game.v1.ClientMessage.archetype_selection:type_name -> game.v1.ArchetypeSelectionRequest
	55,  // 33: game.v1.ClientMessage.use_equipment:type_name -> game.v1.UseEquipmentRequest
	62,  // 34: game.v1.ClientMessage.room_equip:type_name -> game.v1.RoomEquipRequest
	56,  // 35: game.v1.ClientMessage.map:type_name -> game.v1.MapRequest
	59,  // 36: game.v1.ClientMessage.skills_request:type_name -> game.v1.SkillsRequest
	75,  // 37: game.v1.ClientMessage.feats_request:type_name -> game.v1.FeatsRequest
	81,  // 38: game.v1.ClientMessage.interact_request:type_name -> game.v1.InteractRequest
	83,  // 39: game.v1.ClientMessage.use_request:type_name -> game.v1.UseRequest
	78,  // 40: game.v1.ClientMessage.class_features_request:type_name -> game.v1.ClassFeaturesRequest
	52,  // 41: game.v1.ClientMessage.summon_item:type_name -> game.v1.SummonItemRequest
	90,  // 42: game.v1.ClientMessage.proficiencies_request:type_name -> game.v1.ProficienciesRequest
	93,  // 43: game.v1.ClientMessage.level_up:type_name -> game.v1.LevelUpRequest
	94,  // 44: game.v1.ClientMessage.combat_default:type_name -> game.v1.CombatDefaultRequest
	95,  // 45: game.v1.ClientMessage.train_skill:type_name -> game.v1.TrainSkillRequest
	96,  // 46: game.v1.ClientMessage.action:type_name -> game.v1.ActionRequest
	97,  // 47: game.v1.ClientMessage.raise_shield:type_name -> game.v1.RaiseShieldRequest
	98,  // 48: game.v1.ClientMessage.take_cover:type_name -> game.v1.TakeCoverRequest
	99,  // 49: game.v1.ClientMessage.first_aid:type_name -> game.v1.FirstAidRequest
	100, // 50: game.v1.ClientMessage.feint:type_name -> game.v1.FeintRequest
	101, // 51: game.v1.ClientMessage.demoralize:type_name -> game.v1.DemoralizeRequest
	102, // 52: game.v1.ClientMessage.grapple:type_name -> game.v1.GrappleRequest
	103, // 53: game.v1.ClientMessage.trip:type_name -> game.v1.TripRequest
	108, // 54: game.v1.ClientMessage.hide:type_name -> game.v1.HideRequest
	109, // 55: game.v1.ClientMessage.sneak:type_name -> game.v1.SneakRequest
	110, // 56: game.v1.ClientMessage.divert:type_name -> game.v1.DivertRequest
	111, // 57: game.v1.ClientMessage.escape:type_name -> game.v1.EscapeRequest
	128, // 58: game.v1.ClientMessage.grant:type_name -> game.v1.GrantRequest
	104, // 59: game.v1.ClientMessage.disarm:type_name -> game.v1.DisarmRequest
	105, // 60: game.v1.ClientMessage.stride:type_name -> game.v1.StrideRequest
	106, // 61: game.v1.ClientMessage.shove:type_name -> game.v1.ShoveRequest
	107, // 62: game.v1.ClientMessage.step:type_name -> game.v1.StepRequest
	112, // 63: game.v1.ClientMessage.tumble:type_name -> game.v1.TumbleRequest
	113, // 64: game.v1.ClientMessage.seek:type_name -> game.v1.SeekRequest
	114, // 65: game.v1.ClientMessage.climb:type_name -> game.v1.ClimbRequest
	115, // 66: game.v1.ClientMessage.swim:type_name -> game.v1.SwimRequest
	127, // 67: game.v1.ClientMessage.motive:type_name -> game.v1.MotiveRequest
	116, // 68: game.v1.ClientMessage.calm:type_name -> game.v1.CalmRequest
	117, // 69: game.v1.ClientMessage.hero_point:type_name -> game.v1.HeroPointRequest
	118, // 70: game.v1.ClientMessage.delay:type_name -> game.v1.DelayRequest
	119, // 71: game.v1.ClientMessage.join:type_name -> game.v1.JoinRequest
	120, // 72: game.v1.ClientMessage.decline:type_name -> game.v1.DeclineRequest
	121, // 73: game.v1.ClientMessage.group:type_name -> game.v1.GroupRequest
	122, // 74: game.v1.ClientMessage.invite:type_name -> game.v1.InviteRequest
	123, // 75: game.v1.ClientMessage.accept_group:type_name -> game.v1.AcceptGroupRequest
	124, // 76: game.v1.ClientMessage.decline_group:type_name -> game.v1.DeclineGroupRequest
	125, // 77: game.v1.ClientMessage.ungroup:type_name -> game.v1.UngroupRequest
	126, // 78: game.v1.ClientMessage.kick:type_name -> game.v1.KickRequest
	...
	20,  // 83: game.v1.ServerEvent.room_view:type_name -> game.v1.RoomView
	22,  // 84: game.v1.ServerEvent.message:type_name -> game.v1.MessageEvent
	23,  // 85: game.v1.ServerEvent.room_event:type_name -> game.v1.RoomEvent
	24,  // 86: game.v1.ServerEvent.player_list:type_name -> game.v1.PlayerList
	26,  // 87: game.v1.ServerEvent.exit_list:type_name -> game.v1.ExitList
	27,  // 88: game.v1.ServerEvent.error:type_name -> game.v1.ErrorEvent
	28,  // 89: game.v1.ServerEvent.disconnected:type_name -> game.v1.Disconnected
	30,  // 90: game.v1.ServerEvent.character_info:type_name -> game.v1.CharacterInfo
	33,  // 91: game.v1.ServerEvent.npc_view:type_name -> game.v1.NpcView
	67,  // 92: game.v1.ServerEvent.combat_event:type_name -> game.v1.CombatEvent
	65,  // 93: game.v1.ServerEvent.round_start:type_name -> game.v1.RoundStartEvent
	66,  // 94: game.v1.ServerEvent.round_end:type_name -> game.v1.RoundEndEvent
	69,  // 95: game.v1.ServerEvent.condition_event:type_name -> game.v1.ConditionEvent
	64,  // 96: game.v1.ServerEvent.inventory_view:type_name -> game.v1.InventoryView
	29,  // 97: game.v1.ServerEvent.time_of_day:type_name -> game.v1.TimeOfDayEvent
	86,  // 98: game.v1.ServerEvent.character_sheet:type_name -> game.v1.CharacterSheetView
	58,  // 99: game.v1.ServerEvent.map:type_name -> game.v1.MapResponse
	61,  // 100: game.v1.ServerEvent.skills_response:type_name -> game.v1.SkillsResponse
	77,  // 101: game.v1.ServerEvent.feats_response:type_name -> game.v1.FeatsResponse
	82,  // 102: game.v1.ServerEvent.interact_response:type_name -> game.v1.InteractResponse
	84,  // 103: game.v1.ServerEvent.use_response:type_name -> game.v1.UseResponse
	80,  // 104: game.v1.ServerEvent.class_features_response:type_name -> game.v1.ClassFeaturesResponse
	92,  // 105: game.v1.ServerEvent.proficiencies_response:type_name -> game.v1.ProficienciesResponse
	10,  // 106: game.v1.ServerEvent.hp_update:type_name -> game.v1.HpUpdateEvent
	21,  // 107: game.v1.RoomView.exits:type_name -> game.v1.ExitInfo
	31,  // 108: game.v1.RoomView.npcs:type_name -> game.v1.NpcInfo
	72,  // 109: game.v1.RoomView.active_conditions:type_name -> game.v1.ConditionInfo
	53,  // 110: game.v1.RoomView.floor_items:type_name -> game.v1.FloorItem
	54,  // 111: game.v1.RoomView.equipment:type_name -> game.v1.RoomEquipmentItem
	0,   // 112: game.v1.MessageEvent.type:type_name -> game.v1.MessageType
	1,   // 113: game.v1.RoomEvent.type:type_name -> game.v1.RoomEventType
	25,  // 114: game.v1.PlayerList.players:type_name -> game.v1.PlayerInfo
	2,   // 115: game.v1.PlayerInfo.status:type_name -> game.v1.CombatStatus
	21,  // 116: game.v1.ExitList.exits:type_name -> game.v1.ExitInfo
	57,  // 117: game.v1.MapResponse.tiles:type_name -> game.v1.MapTile
	60,  // 118: game.v1.SkillsResponse.skills:type_name -> game.v1.SkillEntry
	63,  // 119: game.v1.InventoryView.items:type_name -> game.v1.InventoryItem
	3,   // 120: game.v1.CombatEvent.type:type_name -> game.v1.CombatEventType
	76,  // 121: game.v1.FeatsResponse.feats:type_name -> game.v1.FeatEntry
	79,  // 122: game.v1.ClassFeaturesResponse.archetype_features:type_name -> game.v1.ClassFeatureEntry
	79,  // 123: game.v1.ClassFeaturesResponse.job_features:type_name -> game.v1.ClassFeatureEntry
	76,  // 124: game.v1.UseResponse.choices:type_name -> game.v1.FeatEntry
	129, // 125: game.v1.CharacterSheetView.armor:type_name -> game.v1.CharacterSheetView.ArmorEntry
	130, // 126: game.v1.CharacterSheetView.accessories:type_name -> game.v1.CharacterSheetView.AccessoriesEntry
	89,  // 127: game.v1.CharacterSheetView.player_resistances:type_name -> game.v1.ResistanceEntry
	89,  // 128: game.v1.CharacterSheetView.player_weaknesses:type_name -> game.v1.ResistanceEntry
	60,  // 129: game.v1.CharacterSheetView.skills:type_name -> game.v1.SkillEntry
	76,  // 130: game.v1.CharacterSheetView.feats:type_name -> game.v1.FeatEntry
	79,  // 131: game.v1.CharacterSheetView.class_features:type_name -> game.v1.ClassFeatureEntry
	91,  // 132: game.v1.CharacterSheetView.proficiencies:type_name -> game.v1.ProficiencyEntry
	85,  // 133: game.v1.CharacterSheetView.prepared_slots:type_name -> game.v1.PreparedSlotView
	88,  // 134: game.v1.CharacterSheetView.spontaneous_use_pools:type_name -> game.v1.SpontaneousUsePoolView
	87,  // 135: game.v1.CharacterSheetView.innate_slots:type_name -> game.v1.InnateSlotView
	91,  // 136: game.v1.ProficienciesResponse.proficiencies:type_name -> game.v1.ProficiencyEntry
	4,   // 137: game.v1.GameService.Session:input_type -> game.v1.ClientMessage
	9,   // 138: game.v1.GameService.Session:output_type -> game.v1.ServerEvent
