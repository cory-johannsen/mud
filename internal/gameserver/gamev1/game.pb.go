...
const file_game_v1_game_proto_rawDesc = "" +
	"\n" +
	"\x12game/v1/game.proto\x12\agame.v1\"\xd4*\n" +
	...
	"\adismiss\x18d \x01(\v2\x17.game.v1.DismissRequestH\x00R\adismissB\t\n" +
	"\apayload\"\r\n" +
	"\vRestRequest\"\x13\n" +
...
var file_game_v1_game_proto_msgTypes = make([]protoimpl.MessageInfo, 143)
var file_game_v1_game_proto_goTypes = []any{
	...
	(*DeployTrapRequest)(nil),         // 24: game.v1.DeployTrapRequest
	(*ServerEvent)(nil),               // 25: game.v1.ServerEvent
	(*HpUpdateEvent)(nil),             // 26: game.v1.HpUpdateEvent
	(*JoinWorldRequest)(nil),          // 27: game.v1.JoinWorldRequest
	(*MoveRequest)(nil),               // 28: game.v1.MoveRequest
	(*LookRequest)(nil),               // 29: game.v1.LookRequest
	(*SayRequest)(nil),                // 30: game.v1.SayRequest
	(*EmoteRequest)(nil),              // 31: game.v1.EmoteRequest
	(*WhoRequest)(nil),                // 32: game.v1.WhoRequest
	(*ExitsRequest)(nil),              // 33: game.v1.ExitsRequest
	(*QuitRequest)(nil),               // 34: game.v1.QuitRequest
	(*SwitchCharacterRequest)(nil),    // 35: game.v1.SwitchCharacterRequest
	(*RoomView)(nil),                  // 36: game.v1.RoomView
	(*ExitInfo)(nil),                  // 37: game.v1.ExitInfo
	(*MessageEvent)(nil),              // 38: game.v1.MessageEvent
	(*RoomEvent)(nil),                 // 39: game.v1.RoomEvent
	(*PlayerList)(nil),                // 40: game.v1.PlayerList
	(*PlayerInfo)(nil),                // 41: game.v1.PlayerInfo
	(*ExitList)(nil),                  // 42: game.v1.ExitList
	(*ErrorEvent)(nil),                // 43: game.v1.ErrorEvent
	(*Disconnected)(nil),              // 44: game.v1.Disconnected
	(*TimeOfDayEvent)(nil),            // 45: game.v1.TimeOfDayEvent
	(*CharacterInfo)(nil),             // 46: game.v1.CharacterInfo
	(*NpcInfo)(nil),                   // 47: game.v1.NpcInfo
	(*ExamineRequest)(nil),            // 48: game.v1.ExamineRequest
	(*NpcView)(nil),                   // 49: game.v1.NpcView
	(*AttackRequest)(nil),             // 50: game.v1.AttackRequest
	(*FleeRequest)(nil),               // 51: game.v1.FleeRequest
	(*PassRequest)(nil),               // 52: game.v1.PassRequest
	(*StrikeRequest)(nil),             // 53: game.v1.StrikeRequest
	(*EquipRequest)(nil),              // 54: game.v1.EquipRequest
	(*ReloadRequest)(nil),             // 55: game.v1.ReloadRequest
	(*FireBurstRequest)(nil),          // 56: game.v1.FireBurstRequest
	(*FireAutomaticRequest)(nil),      // 57: game.v1.FireAutomaticRequest
	(*ThrowRequest)(nil),              // 58: game.v1.ThrowRequest
	(*InventoryRequest)(nil),          // 59: game.v1.InventoryRequest
	(*GetItemRequest)(nil),            // 60: game.v1.GetItemRequest
	(*DropItemRequest)(nil),           // 61: game.v1.DropItemRequest
	(*BalanceRequest)(nil),            // 62: game.v1.BalanceRequest
	(*SetRoleRequest)(nil),            // 63: game.v1.SetRoleRequest
	(*LoadoutRequest)(nil),            // 64: game.v1.LoadoutRequest
	(*UnequipRequest)(nil),            // 65: game.v1.UnequipRequest
	(*EquipmentRequest)(nil),          // 66: game.v1.EquipmentRequest
	(*TeleportRequest)(nil),           // 67: game.v1.TeleportRequest
	(*SummonItemRequest)(nil),         // 68: game.v1.SummonItemRequest
	(*FloorItem)(nil),                 // 69: game.v1.FloorItem
	(*RoomEquipmentItem)(nil),         // 70: game.v1.RoomEquipmentItem
	(*UseEquipmentRequest)(nil),       // 71: game.v1.UseEquipmentRequest
	(*MapRequest)(nil),                // 72: game.v1.MapRequest
	(*MapTile)(nil),                   // 73: game.v1.MapTile
	(*MapResponse)(nil),               // 74: game.v1.MapResponse
	(*SkillsRequest)(nil),             // 75: game.v1.SkillsRequest
	(*SkillEntry)(nil),                // 76: game.v1.SkillEntry
	(*SkillsResponse)(nil),            // 77: game.v1.SkillsResponse
	(*RoomEquipRequest)(nil),          // 78: game.v1.RoomEquipRequest
	(*InventoryItem)(nil),             // 79: game.v1.InventoryItem
	(*InventoryView)(nil),             // 80: game.v1.InventoryView
	(*RoundStartEvent)(nil),           // 81: game.v1.RoundStartEvent
	(*RoundEndEvent)(nil),             // 82: game.v1.RoundEndEvent
	(*CombatEvent)(nil),               // 83: game.v1.CombatEvent
	(*StatusRequest)(nil),             // 84: game.v1.StatusRequest
	(*ConditionEvent)(nil),            // 85: game.v1.ConditionEvent
	(*WearRequest)(nil),               // 86: game.v1.WearRequest
	(*RemoveArmorRequest)(nil),        // 87: game.v1.RemoveArmorRequest
	(*ConditionInfo)(nil),             // 88: game.v1.ConditionInfo
	(*CharacterSheetRequest)(nil),     // 89: game.v1.CharacterSheetRequest
	(*ArchetypeSelectionRequest)(nil), // 90: game.v1.ArchetypeSelectionRequest
	(*FeatsRequest)(nil),              // 91: game.v1.FeatsRequest
	(*FeatEntry)(nil),                 // 92: game.v1.FeatEntry
	(*FeatsResponse)(nil),             // 93: game.v1.FeatsResponse
	(*ClassFeaturesRequest)(nil),      // 94: game.v1.ClassFeaturesRequest
	(*ClassFeatureEntry)(nil),         // 95: game.v1.ClassFeatureEntry
	(*ClassFeaturesResponse)(nil),     // 96: game.v1.ClassFeaturesResponse
	(*InteractRequest)(nil),           // 97: game.v1.InteractRequest
	(*InteractResponse)(nil),          // 98: game.v1.InteractResponse
	(*UseRequest)(nil),                // 99: game.v1.UseRequest
	(*UseResponse)(nil),               // 100: game.v1.UseResponse
	(*PreparedSlotView)(nil),          // 101: game.v1.PreparedSlotView
	(*CharacterSheetView)(nil),        // 102: game.v1.CharacterSheetView
	(*InnateSlotView)(nil),            // 103: game.v1.InnateSlotView
	(*SpontaneousUsePoolView)(nil),    // 104: game.v1.SpontaneousUsePoolView
	(*ResistanceEntry)(nil),           // 105: game.v1.ResistanceEntry
	(*ProficienciesRequest)(nil),      // 106: game.v1.ProficienciesRequest
	(*ProficiencyEntry)(nil),          // 107: game.v1.ProficiencyEntry
	(*ProficienciesResponse)(nil),     // 108: game.v1.ProficienciesResponse
	(*LevelUpRequest)(nil),            // 109: game.v1.LevelUpRequest
	(*CombatDefaultRequest)(nil),      // 110: game.v1.CombatDefaultRequest
	(*TrainSkillRequest)(nil),         // 111: game.v1.TrainSkillRequest
	(*ActionRequest)(nil),             // 112: game.v1.ActionRequest
	(*RaiseShieldRequest)(nil),        // 113: game.v1.RaiseShieldRequest
	(*TakeCoverRequest)(nil),          // 114: game.v1.TakeCoverRequest
	(*FirstAidRequest)(nil),           // 115: game.v1.FirstAidRequest
	(*FeintRequest)(nil),              // 116: game.v1.FeintRequest
	(*DemoralizeRequest)(nil),         // 117: game.v1.DemoralizeRequest
	(*GrappleRequest)(nil),            // 118: game.v1.GrappleRequest
	(*TripRequest)(nil),               // 119: game.v1.TripRequest
	(*DisarmRequest)(nil),             // 120: game.v1.DisarmRequest
	(*StrideRequest)(nil),             // 121: game.v1.StrideRequest
	(*ShoveRequest)(nil),              // 122: game.v1.ShoveRequest
	(*StepRequest)(nil),               // 123: game.v1.StepRequest
	(*HideRequest)(nil),               // 124: game.v1.HideRequest
	(*SneakRequest)(nil),              // 125: game.v1.SneakRequest
	(*DivertRequest)(nil),             // 126: game.v1.DivertRequest
	(*EscapeRequest)(nil),             // 127: game.v1.EscapeRequest
	(*TumbleRequest)(nil),             // 128: game.v1.TumbleRequest
	(*SeekRequest)(nil),               // 129: game.v1.SeekRequest
	(*ClimbRequest)(nil),              // 130: game.v1.ClimbRequest
	(*SwimRequest)(nil),               // 131: game.v1.SwimRequest
	(*CalmRequest)(nil),               // 132: game.v1.CalmRequest
	(*HeroPointRequest)(nil),          // 133: game.v1.HeroPointRequest
	(*DelayRequest)(nil),              // 134: game.v1.DelayRequest
	(*JoinRequest)(nil),               // 135: game.v1.JoinRequest
	(*DeclineRequest)(nil),            // 136: game.v1.DeclineRequest
	(*GroupRequest)(nil),              // 137: game.v1.GroupRequest
	(*InviteRequest)(nil),             // 138: game.v1.InviteRequest
	(*AcceptGroupRequest)(nil),        // 139: game.v1.AcceptGroupRequest
	(*DeclineGroupRequest)(nil),       // 140: game.v1.DeclineGroupRequest
	(*UngroupRequest)(nil),            // 141: game.v1.UngroupRequest
	(*KickRequest)(nil),               // 142: game.v1.KickRequest
	(*MotiveRequest)(nil),             // 143: game.v1.MotiveRequest
	(*GrantRequest)(nil),              // 144: game.v1.GrantRequest
	nil,                               // 145: game.v1.CharacterSheetView.ArmorEntry
	nil,                               // 146: game.v1.CharacterSheetView.AccessoriesEntry
}
var file_game_v1_game_proto_depIdxs = []int32{
	27,  // 0: game.v1.ClientMessage.join_world:type_name -> game.v1.JoinWorldRequest
	28,  // 1: game.v1.ClientMessage.move:type_name -> game.v1.MoveRequest
	29,  // 2: game.v1.ClientMessage.look:type_name -> game.v1.LookRequest
	30,  // 3: game.v1.ClientMessage.say:type_name -> game.v1.SayRequest
	31,  // 4: game.v1.ClientMessage.emote:type_name -> game.v1.EmoteRequest
	32,  // 5: game.v1.ClientMessage.who:type_name -> game.v1.WhoRequest
	33,  // 6: game.v1.ClientMessage.exits:type_name -> game.v1.ExitsRequest
	34,  // 7: game.v1.ClientMessage.quit:type_name -> game.v1.QuitRequest
	48,  // 8: game.v1.ClientMessage.examine:type_name -> game.v1.ExamineRequest
	50,  // 9: game.v1.ClientMessage.attack:type_name -> game.v1.AttackRequest
	51,  // 10: game.v1.ClientMessage.flee:type_name -> game.v1.FleeRequest
	52,  // 11: game.v1.ClientMessage.pass:type_name -> game.v1.PassRequest
	53,  // 12: game.v1.ClientMessage.strike:type_name -> game.v1.StrikeRequest
	84,  // 13: game.v1.ClientMessage.status:type_name -> game.v1.StatusRequest
	54,  // 14: game.v1.ClientMessage.equip:type_name -> game.v1.EquipRequest
	55,  // 15: game.v1.ClientMessage.reload:type_name -> game.v1.ReloadRequest
	56,  // 16: game.v1.ClientMessage.fire_burst:type_name -> game.v1.FireBurstRequest
	57,  // 17: game.v1.ClientMessage.fire_automatic:type_name -> game.v1.FireAutomaticRequest
	58,  // 18: game.v1.ClientMessage.throw:type_name -> game.v1.ThrowRequest
	59,  // 19: game.v1.ClientMessage.inventory_req:type_name -> game.v1.InventoryRequest
	60,  // 20: game.v1.ClientMessage.get_item:type_name -> game.v1.GetItemRequest
	61,  // 21: game.v1.ClientMessage.drop_item:type_name -> game.v1.DropItemRequest
	62,  // 22: game.v1.ClientMessage.balance:type_name -> game.v1.BalanceRequest
	63,  // 23: game.v1.ClientMessage.set_role:type_name -> game.v1.SetRoleRequest
	67,  // 24: game.v1.ClientMessage.teleport:type_name -> game.v1.TeleportRequest
	64,  // 25: game.v1.ClientMessage.loadout:type_name -> game.v1.LoadoutRequest
	65,  // 26: game.v1.ClientMessage.unequip:type_name -> game.v1.UnequipRequest
	66,  // 27: game.v1.ClientMessage.equipment:type_name -> game.v1.EquipmentRequest
	35,  // 28: game.v1.ClientMessage.switch_character:type_name -> game.v1.SwitchCharacterRequest
	86,  // 29: game.v1.ClientMessage.wear:type_name -> game.v1.WearRequest
	87,  // 30: game.v1.ClientMessage.remove_armor:type_name -> game.v1.RemoveArmorRequest
	89,  // 31: game.v1.ClientMessage.char_sheet:type_name -> game.v1.CharacterSheetRequest
	90,  // 32: game.v1.ClientMessage.archetype_selection:type_name -> game.v1.ArchetypeSelectionRequest
	71,  // 33: game.v1.ClientMessage.use_equipment:type_name -> game.v1.UseEquipmentRequest
	78,  // 34: game.v1.ClientMessage.room_equip:type_name -> game.v1.RoomEquipRequest
	72,  // 35: game.v1.ClientMessage.map:type_name -> game.v1.MapRequest
	75,  // 36: game.v1.ClientMessage.skills_request:type_name -> game.v1.SkillsRequest
	91,  // 37: game.v1.ClientMessage.feats_request:type_name -> game.v1.FeatsRequest
	97,  // 38: game.v1.ClientMessage.interact_request:type_name -> game.v1.InteractRequest
	99,  // 39: game.v1.ClientMessage.use_request:type_name -> game.v1.UseRequest
	94,  // 40: game.v1.ClientMessage.class_features_request:type_name -> game.v1.ClassFeaturesRequest
	68,  // 41: game.v1.ClientMessage.summon_item:type_name -> game.v1.SummonItemRequest
	106, // 42: game.v1.ClientMessage.proficiencies_request:type_name -> game.v1.ProficienciesRequest
	109, // 43: game.v1.ClientMessage.level_up:type_name -> game.v1.LevelUpRequest
	110, // 44: game.v1.ClientMessage.combat_default:type_name -> game.v1.CombatDefaultRequest
	111, // 45: game.v1.ClientMessage.train_skill:type_name -> game.v1.TrainSkillRequest
	112, // 46: game.v1.ClientMessage.action:type_name -> game.v1.ActionRequest
	113, // 47: game.v1.ClientMessage.raise_shield:type_name -> game.v1.RaiseShieldRequest
	114, // 48: game.v1.ClientMessage.take_cover:type_name -> game.v1.TakeCoverRequest
	115, // 49: game.v1.ClientMessage.first_aid:type_name -> game.v1.FirstAidRequest
	116, // 50: game.v1.ClientMessage.feint:type_name -> game.v1.FeintRequest
	117, // 51: game.v1.ClientMessage.demoralize:type_name -> game.v1.DemoralizeRequest
	118, // 52: game.v1.ClientMessage.grapple:type_name -> game.v1.GrappleRequest
	119, // 53: game.v1.ClientMessage.trip:type_name -> game.v1.TripRequest
	124, // 54: game.v1.ClientMessage.hide:type_name -> game.v1.HideRequest
	125, // 55: game.v1.ClientMessage.sneak:type_name -> game.v1.SneakRequest
	126, // 56: game.v1.ClientMessage.divert:type_name -> game.v1.DivertRequest
	127, // 57: game.v1.ClientMessage.escape:type_name -> game.v1.EscapeRequest
	144, // 58: game.v1.ClientMessage.grant:type_name -> game.v1.GrantRequest
	120, // 59: game.v1.ClientMessage.disarm:type_name -> game.v1.DisarmRequest
	121, // 60: game.v1.ClientMessage.stride:type_name -> game.v1.StrideRequest
	122, // 61: game.v1.ClientMessage.shove:type_name -> game.v1.ShoveRequest
	123, // 62: game.v1.ClientMessage.step:type_name -> game.v1.StepRequest
	128, // 63: game.v1.ClientMessage.tumble:type_name -> game.v1.TumbleRequest
	129, // 64: game.v1.ClientMessage.seek:type_name -> game.v1.SeekRequest
	130, // 65: game.v1.ClientMessage.climb:type_name -> game.v1.ClimbRequest
	131, // 66: game.v1.ClientMessage.swim:type_name -> game.v1.SwimRequest
	143, // 67: game.v1.ClientMessage.motive:type_name -> game.v1.MotiveRequest
	132, // 68: game.v1.ClientMessage.calm:type_name -> game.v1.CalmRequest
	133, // 69: game.v1.ClientMessage.hero_point:type_name -> game.v1.HeroPointRequest
	134, // 70: game.v1.ClientMessage.delay:type_name -> game.v1.DelayRequest
	135, // 71: game.v1.ClientMessage.join:type_name -> game.v1.JoinRequest
	136, // 72: game.v1.ClientMessage.decline:type_name -> game.v1.DeclineRequest
	137, // 73: game.v1.ClientMessage.group:type_name -> game.v1.GroupRequest
	138, // 74: game.v1.ClientMessage.invite:type_name -> game.v1.InviteRequest
	139, // 75: game.v1.ClientMessage.accept_group:type_name -> game.v1.AcceptGroupRequest
	140, // 76: game.v1.ClientMessage.decline_group:type_name -> game.v1.DeclineGroupRequest
	141, // 77: game.v1.ClientMessage.ungroup:type_name -> game.v1.UngroupRequest
	142, // 78: game.v1.ClientMessage.kick:type_name -> game.v1.KickRequest
	...
	24,  // 83: game.v1.ClientMessage.deploy_trap:type_name -> game.v1.DeployTrapRequest
	...
	36,  // 99: game.v1.ServerEvent.room_view:type_name -> game.v1.RoomView
	38,  // 100: game.v1.ServerEvent.message:type_name -> game.v1.MessageEvent
	39,  // 101: game.v1.ServerEvent.room_event:type_name -> game.v1.RoomEvent
	40,  // 102: game.v1.ServerEvent.player_list:type_name -> game.v1.PlayerList
	42,  // 103: game.v1.ServerEvent.exit_list:type_name -> game.v1.ExitList
	43,  // 104: game.v1.ServerEvent.error:type_name -> game.v1.ErrorEvent
	44,  // 105: game.v1.ServerEvent.disconnected:type_name -> game.v1.Disconnected
	46,  // 106: game.v1.ServerEvent.character_info:type_name -> game.v1.CharacterInfo
	49,  // 107: game.v1.ServerEvent.npc_view:type_name -> game.v1.NpcView
	83,  // 108: game.v1.ServerEvent.combat_event:type_name -> game.v1.CombatEvent
	81,  // 109: game.v1.ServerEvent.round_start:type_name -> game.v1.RoundStartEvent
	82,  // 110: game.v1.ServerEvent.round_end:type_name -> game.v1.RoundEndEvent
	85,  // 111: game.v1.ServerEvent.condition_event:type_name -> game.v1.ConditionEvent
	80,  // 112: game.v1.ServerEvent.inventory_view:type_name -> game.v1.InventoryView
	45,  // 113: game.v1.ServerEvent.time_of_day:type_name -> game.v1.TimeOfDayEvent
	102, // 114: game.v1.ServerEvent.character_sheet:type_name -> game.v1.CharacterSheetView
	74,  // 115: game.v1.ServerEvent.map:type_name -> game.v1.MapResponse
	77,  // 116: game.v1.ServerEvent.skills_response:type_name -> game.v1.SkillsResponse
	93,  // 117: game.v1.ServerEvent.feats_response:type_name -> game.v1.FeatsResponse
	98,  // 118: game.v1.ServerEvent.interact_response:type_name -> game.v1.InteractResponse
	100, // 119: game.v1.ServerEvent.use_response:type_name -> game.v1.UseResponse
	96,  // 120: game.v1.ServerEvent.class_features_response:type_name -> game.v1.ClassFeaturesResponse
	108, // 121: game.v1.ServerEvent.proficiencies_response:type_name -> game.v1.ProficienciesResponse
	26,  // 122: game.v1.ServerEvent.hp_update:type_name -> game.v1.HpUpdateEvent
	37,  // 123: game.v1.RoomView.exits:type_name -> game.v1.ExitInfo
	47,  // 124: game.v1.RoomView.npcs:type_name -> game.v1.NpcInfo
	88,  // 125: game.v1.RoomView.active_conditions:type_name -> game.v1.ConditionInfo
	69,  // 126: game.v1.RoomView.floor_items:type_name -> game.v1.FloorItem
	70,  // 127: game.v1.RoomView.equipment:type_name -> game.v1.RoomEquipmentItem
	0,   // 128: game.v1.MessageEvent.type:type_name -> game.v1.MessageType
	1,   // 129: game.v1.RoomEvent.type:type_name -> game.v1.RoomEventType
	41,  // 130: game.v1.PlayerList.players:type_name -> game.v1.PlayerInfo
	2,   // 131: game.v1.PlayerInfo.status:type_name -> game.v1.CombatStatus
	37,  // 132: game.v1.ExitList.exits:type_name -> game.v1.ExitInfo
	73,  // 133: game.v1.MapResponse.tiles:type_name -> game.v1.MapTile
	76,  // 134: game.v1.SkillsResponse.skills:type_name -> game.v1.SkillEntry
	79,  // 135: game.v1.InventoryView.items:type_name -> game.v1.InventoryItem
	3,   // 136: game.v1.CombatEvent.type:type_name -> game.v1.CombatEventType
	92,  // 137: game.v1.FeatsResponse.feats:type_name -> game.v1.FeatEntry
	95,  // 138: game.v1.ClassFeaturesResponse.archetype_features:type_name -> game.v1.ClassFeatureEntry
	95,  // 139: game.v1.ClassFeaturesResponse.job_features:type_name -> game.v1.ClassFeatureEntry
	92,  // 140: game.v1.UseResponse.choices:type_name -> game.v1.FeatEntry
	145, // 141: game.v1.CharacterSheetView.armor:type_name -> game.v1.CharacterSheetView.ArmorEntry
	146, // 142: game.v1.CharacterSheetView.accessories:type_name -> game.v1.CharacterSheetView.AccessoriesEntry
	105, // 143: game.v1.CharacterSheetView.player_resistances:type_name -> game.v1.ResistanceEntry
	105, // 144: game.v1.CharacterSheetView.player_weaknesses:type_name -> game.v1.ResistanceEntry
	76,  // 145: game.v1.CharacterSheetView.skills:type_name -> game.v1.SkillEntry
	92,  // 146: game.v1.CharacterSheetView.feats:type_name -> game.v1.FeatEntry
	95,  // 147: game.v1.CharacterSheetView.class_features:type_name -> game.v1.ClassFeatureEntry
	107, // 148: game.v1.CharacterSheetView.proficiencies:type_name -> game.v1.ProficiencyEntry
	101, // 149: game.v1.CharacterSheetView.prepared_slots:type_name -> game.v1.PreparedSlotView
	104, // 150: game.v1.CharacterSheetView.spontaneous_use_pools:type_name -> game.v1.SpontaneousUsePoolView
	103, // 151: game.v1.CharacterSheetView.innate_slots:type_name -> game.v1.InnateSlotView
	107, // 152: game.v1.ProficienciesResponse.proficiencies:type_name -> game.v1.ProficiencyEntry
	4,   // 153: game.v1.GameService.Session:input_type -> game.v1.ClientMessage
	25,  // 154: game.v1.GameService.Session:output_type -> game.v1.ServerEvent
