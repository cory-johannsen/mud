...
const file_game_v1_game_proto_rawDesc = "" +
	...
	"\bexpended\x18\x02 \x01(\bR\bexpended\"\xa6\x0e\n" +
	...
	"\x0eprepared_slots\x18, \x03(\v2\x19.game.v1.PreparedSlotViewR\rpreparedSlots\x1a8\n" +
	"\n" +
	"ArmorEntry\x12\x10\n" +
...
var file_game_v1_game_proto_msgTypes = make([]protoimpl.MessageInfo, 123)
var file_game_v1_game_proto_goTypes = []any{
	...
	(*ResistanceEntry)(nil),           // 85: game.v1.ResistanceEntry
	(*ProficienciesRequest)(nil),      // 86: game.v1.ProficienciesRequest
	(*ProficiencyEntry)(nil),          // 87: game.v1.ProficiencyEntry
	(*ProficienciesResponse)(nil),     // 88: game.v1.ProficienciesResponse
	(*LevelUpRequest)(nil),            // 89: game.v1.LevelUpRequest
	(*CombatDefaultRequest)(nil),      // 90: game.v1.CombatDefaultRequest
	(*TrainSkillRequest)(nil),         // 91: game.v1.TrainSkillRequest
	(*ActionRequest)(nil),             // 92: game.v1.ActionRequest
	(*RaiseShieldRequest)(nil),        // 93: game.v1.RaiseShieldRequest
	(*TakeCoverRequest)(nil),          // 94: game.v1.TakeCoverRequest
	(*FirstAidRequest)(nil),           // 95: game.v1.FirstAidRequest
	(*FeintRequest)(nil),              // 96: game.v1.FeintRequest
	(*DemoralizeRequest)(nil),         // 97: game.v1.DemoralizeRequest
	(*GrappleRequest)(nil),            // 98: game.v1.GrappleRequest
	(*TripRequest)(nil),               // 99: game.v1.TripRequest
	(*DisarmRequest)(nil),             // 100: game.v1.DisarmRequest
	(*StrideRequest)(nil),             // 101: game.v1.StrideRequest
	(*ShoveRequest)(nil),              // 102: game.v1.ShoveRequest
	(*StepRequest)(nil),               // 103: game.v1.StepRequest
	(*HideRequest)(nil),               // 104: game.v1.HideRequest
	(*SneakRequest)(nil),              // 105: game.v1.SneakRequest
	(*DivertRequest)(nil),             // 106: game.v1.DivertRequest
	(*EscapeRequest)(nil),             // 107: game.v1.EscapeRequest
	(*TumbleRequest)(nil),             // 108: game.v1.TumbleRequest
	(*SeekRequest)(nil),               // 109: game.v1.SeekRequest
	(*ClimbRequest)(nil),              // 110: game.v1.ClimbRequest
	(*SwimRequest)(nil),               // 111: game.v1.SwimRequest
	(*CalmRequest)(nil),               // 112: game.v1.CalmRequest
	(*HeroPointRequest)(nil),          // 113: game.v1.HeroPointRequest
	(*DelayRequest)(nil),              // 114: game.v1.DelayRequest
	(*JoinRequest)(nil),               // 115: game.v1.JoinRequest
	(*DeclineRequest)(nil),            // 116: game.v1.DeclineRequest
	(*GroupRequest)(nil),              // 117: game.v1.GroupRequest
	(*InviteRequest)(nil),             // 118: game.v1.InviteRequest
	(*AcceptGroupRequest)(nil),        // 119: game.v1.AcceptGroupRequest
	(*DeclineGroupRequest)(nil),       // 120: game.v1.DeclineGroupRequest
	(*UngroupRequest)(nil),            // 121: game.v1.UngroupRequest
	(*KickRequest)(nil),               // 122: game.v1.KickRequest
	(*MotiveRequest)(nil),             // 123: game.v1.MotiveRequest
	(*GrantRequest)(nil),              // 124: game.v1.GrantRequest
	nil,                               // 125: game.v1.CharacterSheetView.ArmorEntry
	nil,                               // 126: game.v1.CharacterSheetView.AccessoriesEntry
}
var file_game_v1_game_proto_depIdxs = []int32{
	...
	86,  // 42: game.v1.ClientMessage.proficiencies_request:type_name -> game.v1.ProficienciesRequest
	89,  // 43: game.v1.ClientMessage.level_up:type_name -> game.v1.LevelUpRequest
	90,  // 44: game.v1.ClientMessage.combat_default:type_name -> game.v1.CombatDefaultRequest
	91,  // 45: game.v1.ClientMessage.train_skill:type_name -> game.v1.TrainSkillRequest
	92,  // 46: game.v1.ClientMessage.action:type_name -> game.v1.ActionRequest
	93,  // 47: game.v1.ClientMessage.raise_shield:type_name -> game.v1.RaiseShieldRequest
	94,  // 48: game.v1.ClientMessage.take_cover:type_name -> game.v1.TakeCoverRequest
	95,  // 49: game.v1.ClientMessage.first_aid:type_name -> game.v1.FirstAidRequest
	96,  // 50: game.v1.ClientMessage.feint:type_name -> game.v1.FeintRequest
	97,  // 51: game.v1.ClientMessage.demoralize:type_name -> game.v1.DemoralizeRequest
	98,  // 52: game.v1.ClientMessage.grapple:type_name -> game.v1.GrappleRequest
	99,  // 53: game.v1.ClientMessage.trip:type_name -> game.v1.TripRequest
	104, // 54: game.v1.ClientMessage.hide:type_name -> game.v1.HideRequest
	105, // 55: game.v1.ClientMessage.sneak:type_name -> game.v1.SneakRequest
	106, // 56: game.v1.ClientMessage.divert:type_name -> game.v1.DivertRequest
	107, // 57: game.v1.ClientMessage.escape:type_name -> game.v1.EscapeRequest
	124, // 58: game.v1.ClientMessage.grant:type_name -> game.v1.GrantRequest
	100, // 59: game.v1.ClientMessage.disarm:type_name -> game.v1.DisarmRequest
	101, // 60: game.v1.ClientMessage.stride:type_name -> game.v1.StrideRequest
	102, // 61: game.v1.ClientMessage.shove:type_name -> game.v1.ShoveRequest
	103, // 62: game.v1.ClientMessage.step:type_name -> game.v1.StepRequest
	108, // 63: game.v1.ClientMessage.tumble:type_name -> game.v1.TumbleRequest
	109, // 64: game.v1.ClientMessage.seek:type_name -> game.v1.SeekRequest
	110, // 65: game.v1.ClientMessage.climb:type_name -> game.v1.ClimbRequest
	111, // 66: game.v1.ClientMessage.swim:type_name -> game.v1.SwimRequest
	123, // 67: game.v1.ClientMessage.motive:type_name -> game.v1.MotiveRequest
	112, // 68: game.v1.ClientMessage.calm:type_name -> game.v1.CalmRequest
	113, // 69: game.v1.ClientMessage.hero_point:type_name -> game.v1.HeroPointRequest
	114, // 70: game.v1.ClientMessage.delay:type_name -> game.v1.DelayRequest
	115, // 71: game.v1.ClientMessage.join:type_name -> game.v1.JoinRequest
	116, // 72: game.v1.ClientMessage.decline:type_name -> game.v1.DeclineRequest
	117, // 73: game.v1.ClientMessage.group:type_name -> game.v1.GroupRequest
	118, // 74: game.v1.ClientMessage.invite:type_name -> game.v1.InviteRequest
	119, // 75: game.v1.ClientMessage.accept_group:type_name -> game.v1.AcceptGroupRequest
	120, // 76: game.v1.ClientMessage.decline_group:type_name -> game.v1.DeclineGroupRequest
	121, // 77: game.v1.ClientMessage.ungroup:type_name -> game.v1.UngroupRequest
	122, // 78: game.v1.ClientMessage.kick:type_name -> game.v1.KickRequest
	...
	88,  // 103: game.v1.ServerEvent.proficiencies_response:type_name -> game.v1.ProficienciesResponse
	...
	125, // 123: game.v1.CharacterSheetView.armor:type_name -> game.v1.CharacterSheetView.ArmorEntry
	126, // 124: game.v1.CharacterSheetView.accessories:type_name -> game.v1.CharacterSheetView.AccessoriesEntry
	85,  // 125: game.v1.CharacterSheetView.player_resistances:type_name -> game.v1.ResistanceEntry
	85,  // 126: game.v1.CharacterSheetView.player_weaknesses:type_name -> game.v1.ResistanceEntry
	...
	87,  // 130: game.v1.CharacterSheetView.proficiencies:type_name -> game.v1.ProficiencyEntry
	83,  // 131: game.v1.CharacterSheetView.prepared_slots:type_name -> game.v1.PreparedSlotView
	87,  // 132: game.v1.ProficienciesResponse.proficiencies:type_name -> game.v1.ProficiencyEntry
	4,   // 133: game.v1.GameService.Session:input_type -> game.v1.ClientMessage
	7,   // 134: game.v1.GameService.Session:output_type -> game.v1.ServerEvent
