...
func testServiceWithAdmin(t *testing.T, admin AccountAdmin) *GameServiceServer {
	...
	return NewGameServiceServer(worldMgr, sessMgr, cmdRegistry, worldHandler, chatHandler, logger, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, admin, nil, nil, nil, "", nil, nil, nil, nil, nil, nil, nil, nil, nil)
}
