...
func testGRPCServer(t *testing.T) (gamev1.GameServiceClient, *session.Manager) {
	...
	svc := NewGameServiceServer(worldMgr, sessMgr, cmdRegistry, worldHandler, chatHandler, logger, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, "", nil, nil)
