...
func protoMessageByName(name string) (proto.Message, error) {
	typeMap := map[string]func() proto.Message{
		...
		"TrainTechRequest":       func() proto.Message { return &gamev1.TrainTechRequest{} },
		...
		"MoveToRequest":          func() proto.Message { return &gamev1.MoveToRequest{} },
		"ReactionResponse":       func() proto.Message { return &gamev1.ReactionResponse{} },
	}
...
func wrapProtoAsClientMessage(reqID, typeName string, msg proto.Message) (*gamev1.ClientMessage, error) {
	...
	case *gamev1.TrainTechRequest:
		cm.Payload = &gamev1.ClientMessage_TrainTech{TrainTech: m}
	...
	case *gamev1.MoveToRequest:
		cm.Payload = &gamev1.ClientMessage_MoveTo{MoveTo: m}
	case *gamev1.ReactionResponse:
		cm.Payload = &gamev1.ClientMessage_ReactionResponse{ReactionResponse: m}
	default:
