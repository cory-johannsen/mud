...
| 4 | `wreckers_rest` | Wrecker's Rest | safe | (-4, -4) |
| 5 | `the_tinkers_den` | The Tinker's Den | safe | (-2, -4) |
| 6 | `the_graveyard` | The Graveyard | inherit | (0, -4) |
| 7 | `the_mausoleum` | The Mausoleum | inherit | (2, -4) |
| 8 | `scrapshack_23` | Scrapshack 23 | safe | (-4, -2) |
| 9 | `the_heap` | The Heap | safe | (-2, -2) |
| 10 | `rotgut_alley` | Rotgut Alley | safe | (0, -2) |
| 11 | `the_bottle_shack` | The Bottle Shack | safe | (2, -2) |
| 12 | `salvage_hut` | Salvage Hut | safe | (-4, 0) |
...
| 35 | `scorchside_camp` | Scorchside Camp | safe | (4, 12) |
